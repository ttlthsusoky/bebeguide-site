...
const COMMON_PARENT_ANSWERS = [
    ...
    {
        id: 'vaccine-site-swelling-boundary',
        match: /(접종\s*후\s*부기|접종\s*후\s*부기|예방접종\s*팔\s*부어|vaccine\s*site\s*swelling)/,
        title: '접종 부위 가벼운 부기는 흔할 수 있으나 심한 반응·호흡 이상은 진료하세요',
    ...
    {
        id: 'vaccine-fussiness-boundary',
        match: /(접종\s*후\s*보챔|접종\s*후\s*보챔|vaccine\s*fussiness)/,
        title: '접종 후 가벼운 보챔·미열은 흔할 수 있으나 심한 반응은 진료하세요',
        lead: '해열제 용량은 표시·진료를 따르세요.',
        points: [
            ['지금', '관찰'],
            ['주의', '고열·처짐·심한 반응']
    ...
    {
        id: 'febrile-seizure-recur-boundary',
        match: /(열성\s*경련\s*재발|열성\s*경련\s*재발|열\s*경기\s*또|febrile\s*seizure\s*recur)/,
        title: '열성 경련이 반복되면 진료 계획을 따르고 경련 중 입에 물건을 넣지 마세요',
        lead: '응급 신호를 알아 두세요. 약 용량은 의료진을 따르세요.',
        points: [
            ['경련 중', '안전, 시간 측정'],
            ['금지', '입안 물건']
        ],
        blocks: [
            ['지금 할 일', '시간을 재고 주변을 치우세요.'],
            ['하지 않을 일', '물을 먹이려 하지 마세요.'],
            ['관련', '열성 경련 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'fever-tepid-sponge-boundary',
        match: /(열날\s*때\s*미온수\s*마사지|열\s*미온수\s*마사지|해열\s*물수건\s*문지르|fever\s*tepid\s*sponge)/,
        title: '열날 때 알코올·찬물로 문지르지 말고 의료진 안내의 열 관리를 따르세요',
        lead: '해열제 용량은 표시·진료를 따르세요. 여기서 ml를 정하지 않습니다.',
        points: [
            ['원칙', '편안, 수분'],
            ['금지', '알코올 마사지']
        ],
        blocks: [
            ['지금 할 일', '너무 두껍게 덮지 마세요.'],
            ['하지 않을 일', '심하게 떨고 처지면 진료하세요.'],
            ['관련', '열 안내를 참고하세요.']
        ],
        links: [
            ['열 가이드', 'blog/baby-fever-cold-guide.html'],
    ...
    {
        id: 'fever-undress-boundary',
        match: /(열날\s*때\s*옷\s*벗기기|열날\s*때\s*옷\s*벗|fever\s*undress)/,
        title: '열날 때 너무 두껍게 입히지 말고 편안한 옷을 유지하세요',
        lead: '알코올 마사지는 하지 마세요. 해열제 용량은 표시·진료를 따르세요.',
        points: [
            ['환경', '편안한 옷, 수분'],
            ['금지', '알코올 문지르기']
        ],
    ...
    {
        id: 'fever-method-consistency-boundary',
        match: /(열\s*측정\s*방법\s*통일|열\s*측정\s*방법\s*통일|체온계\s*종류\s*섞|fever\s*method\s*consistency)/,
        title: '열 측정 방법을 일정하게 하고 연령별 진료 기준과 전신 상태를 함께 보세요',
        lead: '해열제 용량은 표시·진료를 따르세요. 여기서 ml를 정하지 않습니다.',
        points: [
            ['관찰', '처짐, 수분, 호흡'],
            ['방법', '일정한 측정']
    ...
    {
        id: 'fever-offer-fluids-boundary',
        match: /(열날\s*때\s*물\s*마시기|열날\s*때\s*물|fever\s*offer\s*fluids)/,
        title: '열날 때 수분을 소량씩 자주 권하고 처짐·무뇨면 진료하세요',
        lead: '해열제 용량은 표시·진료를 따르세요.',
        points: [
            ['지금', '수분·관찰'],
            ['주의', '억지 다량']
    ...
    {
        id: 'fever-site-method-boundary',
        match: /(열\s*재는\s*위치|열\s*재는\s*위치|fever\s*site\s*method)/,
        title: '열 측정 위치·방법을 일정하게 하고 전신 상태와 함께 보세요',
        lead: '해열제 용량은 표시·진료를 따르세요. 여기서 ml를 정하지 않습니다.',
        points: [
            ['지금', '일정한 방법·관찰'],
            ['주의', '방법 혼용 혼란']
    ...
    {
        id: 'wake-to-feed-cues-boundary',
        match: /(신생아\s*깨워\s*수유\s*신호|신생아\s*깨워\s*수유\s*신호|wake\s*to\s*feed\s*cues)/,
        title: '깨워 수유 여부는 체중·황달·의료진 계획을 보고 하나의 시간표로 단정하지 마세요',
        lead: '탈수·처짐이 있으면 진료하세요. 용량 단정은 하지 않습니다.',
        points: [
            ['전제', '성장, 의료 계획'],
            ['관찰', '소변, 처짐']
        ],
    ...
    {
        id: 'feeding-app-amount-myth-boundary',
        match: /(수유량\s*앱\s*단정|수유량\s*앱|feeding\s*app\s*amount)/,
        title: '수유량 앱의 한 숫자로  sufficiency를 단정하지 말고 체중·소변·처짐을 보세요',
        lead: '수유량 앱의 한 숫자로 충분 여부를 단정하지 말고 체중·소변·처짐을 보세요',
        points: [
            ['지금', '성장·소변 관찰'],
            ['주의', '앱 숫자 맹신']
        ],
        blocks: [
            ['지금 할 일', '기록을 가지고 상담하세요.'],
            ['하지 않을 일', '앱 숫자만 보고 단정하지 마세요.'],
            ['관련', '수유량 안내를 참고하세요.']
        ],
        links: [
            ['수유 가이드', 'blog/breastfeeding-guide.html'],
    ...
    {
        id: 'breastfeeding-duration-pressure-boundary',
        match: /(모유\s*수유\s*기간\s*압박|모유\s*수유\s*기간\s*압박|breastfeeding\s*duration\s*pressure)/,
        title: '모유 수유 기간은 가족 상황과 권고를 함께 보고 압박·비난을 피하세요',
        lead: '가능하면 권고 기간을 목표로 하되 강요하지 않습니다.',
        points: [
            ['지금', '의료·가족 상황'],
            ['주의', '비난·비교']
        ],
        blocks: [
            ['지금 할 일', '필요하면 수유 상담을 받으세요.'],
            ['하지 않을 일', '남을 비난하지 마세요.'],
            ['관련', '모유 기간 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'weaning-plan-gradual-boundary',
        match: /(단유\s*일정\s*짜기|단유\s*일정|weaning\s*plan\s*gradual)/,
        title: '단유는 하루아침에 끊기보다 점진적으로 하고 유방 울혈·아이 수분에 주의하세요',
        lead: '의료 상황이 있으면 상담하세요. 용량 단정은 하지 않습니다.',
        points: [
            ['지금', '점진적 감소'],
            ['주의', '갑작스런 완전 중단']
        ],
        blocks: [
            ['지금 할 일', '하루 한 회씩 줄여 보세요.'],
            ['하지 않을 일', '유방이 너무 붓고 열나면 진료하세요.'],
            ['관련', '단유 안내를 참고하세요.']
        ],
        links: [
            ['수유 가이드', 'blog/breastfeeding-guide.html'],
    ...
    {
        id: 'bedtime-routine-no-screen-boundary',
        match: /(취침\s*루틴\s*화면\s*없음\s*확인)/,
        title: '취침 루틴에서 화면을 빼고 책·목욕 등 잔잔한 순서로 바꾸세요',
        lead: '앱 순위는 하지 않습니다.',
        points: [
            ['지금', '화면 없는 루틴'],
            ['주의', '침대 영상']
        ...
        blocks: [
            ['지금 할 일', '2~3단계 루틴을 정해 보세요.'],
            ['하지 않을 일', '잠들기 직전 유튜브를 틀지 마세요.'],
            ['관련', '스크린·수면 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'nap-combine-timing-boundary',
        match: /(낮잠\s*합치기\s*시기|낮잠\s*합치|nap\s*combine)/,
        title: '낮잠 합치기는 개월 수만이 아니라 보챔·밤 수면을 보고 점진적으로 하세요',
        lead: '하루아침에 없애지 마세요.',
        points: [
            ['지금', '신호 관찰·점진'],
            ['주의', '강제 드롭']
        ...
        blocks: [
            ['지금 할 일', '취침을 조금 앞당겨 보세요.'],
            ['하지 않을 일', '낮잠을 한꺼번에 없애지 마세요.'],
            ['관련', '낮잠 전환 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'summer-early-light-wake-boundary',
        match: /(여름\s*새벽\s*밝음|새벽\s*밝아\s*깨|summer\s*early\s*light)/,
        title: '여름 새벽 빛으로 일찍 깨면 암막·루틴을 조절하되 한 가지 원인으로 단정하지 마세요',
        lead: '수면제 추천은 하지 않습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '빛·취침·낮잠 점검'],
            ['주의', '새벽 긴 놀이 보상']
        ],
    ...
    {
        id: 'night-terror-vs-nightmare-boundary',
        match: /(야경\s*vs\s*악몽|야경\s*악몽\s*구분|night\s*terror\s*vs\s*nightmare|자다가\s*비명\s*깨우)/,
        title: '야경과 악몽은 대응이 다를 수 있어 위험 행동을 막고 패턴을 기록하세요',
        lead: '억지로 깨워 심문하지 마세요. 잦으면 상담을 검토하세요.',
        points: [
            ['관찰', '기억 여부, 시간대'],
            ['안전', '침대 주변']
        ],
        blocks: [
            ['지금 할 일', '영상을 남겨 진료에 가져가세요.'],
            ['하지 않을 일', '세게 흔들어 깨우지 마세요.'],
            ['관련', '야경·악몽 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'night-wean-guilt-boundary',
        match: /(밤중\s*수유\s*끊기\s*죄책감|밤중\s*수유\s*끊기\s*죄책감|야간\s*수유\s*중단\s*고민|night\s*wean\s*guilt)/,
        title: '밤중 수유를 줄일 때는 성장·의료진 계획을 보고 죄책감만으로 결정하지 마세요',
        lead: '갑자기 굶기듯 끊지 마세요. 용량 단정은 하지 않습니다.',
        points: [
            ['전제', '성장, 상담'],
            ['방법', '점진']
        ],
        blocks: [
            ['지금 할 일', '체중·소변을 확인하세요.'],
            ['하지 않을 일', '신생아에게 밤 수유를 갑자기 없애지 마세요.'],
            ['관련', '밤중 수유 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'night-diaper-change-wake-boundary',
        match: /(밤중\s*기저귀\s*깨움|밤중\s*기저귀\s*교체|night\s*diaper\s*change)/,
        title: '밤중 기저귀 교체는 꼭 필요할 때만 짧게 하고 놀이를 시작하지 마세요',
        lead: '발진이 심하면 교체를 늘리세요.',
        points: [
            ['지금', '짧게·조명 낮게'],
            ['주의', '긴 놀이·밝은 불']
        ],
        blocks: [
            ['지금 할 일', '조용히 빠르게 갈아 주세요.'],
            ['하지 않을 일', '밤중 긴 놀이를 하지 마세요.'],
            ['관련', '밤중 깨어남 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'popcorn-under-four-boundary',
        match: /(돌\s*전\s*팝콘|돌\s*전\s*팝콘|어린\s*아이\s*팝콘|popcorn\s*young\s*child)/,
        title: '어린 아이에게 팝콘은 질식 위험이 커 주지 않는 편이 안전합니다',
        lead: '견과 통째와 마찬가지로 형태가 위험합니다.',
        points: [
            ['원칙', '연령 부적합 치우기'],
            ['감독', '앉아서']
        ],
    ...
    {
        id: 'lollipop-choking-boundary',
        match: /((막대사탕\s*질식|막대\s*사탕\s*아이|lollipop\s*chok))/,
        title: '막대사탕은 달리거나 누워서 빨지 않게 하고 어린 아이 손에 두지 마세요',
        lead: '막대가 깨지거나 삼킬 위험이 있습니다.',
        points: [
            ['감독', '앉아서'],
            ['금지', '달리며, 누워서']
        ],
        blocks: [
            ['지금 할 일', '연령 부적합 사탕을 치우세요.'],
            ['하지 않을 일', '뛰어다니며 빨게 두지 마세요.'],
            ['관련', '딱딱한 사탕 안내를 참고하세요.']
        ],
        links: [
            ['AAP 질식', 'https://www.healthychildren.org/English/health-issues/injuries-emergencies/Pages/Choking-Prevention.aspx'],
    ...
    {
        id: 'grape-skin-choking-boundary',
        match: /(포도\s*껍질\s*질식)/,
        title: '포도는 세로로 자르고 껍질·크기 질식을 보세요',
        lead: '통째로 주지 마세요.',
        points: [
            ['자르기', '세로 4등분'],
            ['감독', '앉아서']
    ...
    {
        id: 'sausage-round-slice-boundary',
        match: /(소시지\s*동그란\s*조각|소시지\s*동그란\s*조각|소시지\s*동전\s*모양|sausage\s*round\s*slice)/,
        title: '소시지·핫도그는 동전 모양 단면 대신 세로로 가른 뒤 작게 자르세요',
        lead: '원통 형태는 질식 위험이 큽니다.',
        points: [
            ['자르기', '세로, 작게'],
            ['금지', '통째 원통']
        ],
    ...
    {
        id: 'whole-cherry-tomato-boundary',
        match: /(방울토마토\s*통째|방울토마토\s*통째|whole\s*cherry\s*tomato)/,
        title: '방울토마토는 통째로 주지 말고 세로로 작게 자르세요',
        lead: '둥근 형태는 기도를 막을 수 있습니다.',
        points: [
            ['지금', '세로 자르기'],
            ['주의', '통째 제공']
    ...
    {
        id: 'dry-cleaning-bag-suffocation-boundary',
        match: /(드라이클리닝\s*비닐|드라이\s*비닐\s*질식|세탁소\s*비닐\s*아이|dry\s*cleaning\s*bag\s*child)/,
        title: '드라이클리닝·포장 비닐은 즉시 버리고 아이 얼굴에 닿지 않게 하세요',
        lead: '질식 위험이 큽니다.',
        points: [
            ['즉시', '비닐 폐기'],
            ['금지', '놀이용']
        ...
        blocks: [
            ['지금 할 일', '도착 즉시 비닐을 제거하세요.'],
            ['하지 않을 일', '옷걸이에 비닐을 남겨 두지 마세요.'],
            ['관련', '비닐 질식 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'shipping-plastic-bag-boundary',
        match: /(택배\s*비닐\s*봉투|택배\s*비닐\s*봉투|배송\s*비닐\s*질식|shipping\s*plastic\s*bag\s*child)/,
        title: '택배 비닐·포장 비닐은 즉시 치우고 아이 얼굴에 닿지 않게 하세요',
        lead: '질식 위험이 큽니다.',
        points: [
            ['즉시', '비닐 폐기'],
            ['금지', '놀이용']
        ...
        blocks: [
            ['지금 할 일', '개봉 즉시 비닐을 버리세요.'],
            ['하지 않을 일', '머리 위에 씌우게 두지 마세요.'],
            ['관련', '비닐 질식 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'garment-bag-plastic-boundary',
        match: /(옷\s*커버\s*비닐|옷\s*커버\s*비닐|garment\s*bag\s*plastic)/,
        title: '옷 커버 비닐은 즉시 제거하고 아이 얼굴에 닿지 않게 하세요',
        lead: '질식 위험이 큽니다.',
        points: [
            ['지금', '즉시 폐기'],
            ['주의', '놀이용']
    ...
    {
        id: 'gum-swallow-child-boundary',
        match: /((껌\s*삼킴\s*아이|아이\s*껌\s*삼켰|gum\s*swallow\s*child|어린이\s*껌\s*삼킴))/,
        title: '어린 아이에게 껌을 주지 말고, 삼켰다면 숨 막힘을 우선 확인하세요',
        lead: '대부분 통과할 수 있으나 호흡 이상은 응급입니다.',
        points: [
            ['원칙', '어린 아이 금지'],
            ['응급', '숨 막힘']
        ],
    ...
    {
        id: 'balloon-piece-choking-boundary',
        match: /(풍선\s*쪼가리|풍선\s*쪼가리\s*질식|터진\s*풍선\s*조각|balloon\s*piece\s*chok)/,
        title: '터진 풍선 조각은 즉시 치우고 어린 아이 손에 두지 마세요',
        lead: '풍선 질식 사고가 보고됩니다.',
        points: [
            ['즉시', '조각 수거'],
            ['금지', '미취학 혼자 풍선']
        ],
    ...
    {
        id: 'blw-choking-prep-boundary',
        match: /(blw\s*질식\s*대비|아기주도\s*질식\s*교육|blw\s*choking\s*prep)/,
        title: 'BLW를 할 때는 질식·구역질 구분과 앉은 자세·감독을 지키고 교육을 검토하세요',
        lead: '브랜드 식기 순위는 하지 않습니다.',
        points: [
            ['안전', '앉기, 감독, 크기'],
            ['금지', '달리며 먹이기']
        ],
        blocks: [
            ['지금 할 일', '응급 교육을 미리 받으세요.'],
            ['하지 않을 일', '견과 통째를 주지 마세요.'],
            ['관련', 'BLW·질식 안내를 참고하세요.']
        ],
        links: [
            ['AAP 질식', 'https://www.healthychildren.org/English/health-issues/injuries-emergencies/Pages/Choking-Prevention.aspx'],
    ...
    {
        id: 'laughing-while-eating-choke-boundary',
        match: /(식사\s*중\s*웃음\s*질식|웃으며\s*먹\s*질식|식사\s*중\s*웃다\s*사레|laughing\s*while\s*eating\s*choke)/,
        title: '식사 중 크게 웃거나 뛰며 먹지 않게 하고 앉아서 천천히 먹이세요',
        lead: '사레·질식을 조심하세요.',
        points: [
            ['환경', '앉아서, 차분'],
            ['금지', '달리며, 누워 먹이기']
    ...
    {
        id: 'gag-vs-choke-boundary',
        match: /(구역질\s*vs\s*질식|구역질\s*질식\s*구분|헛구역질\s*괜찮|gag\s*vs\s*choke)/,
        title: '소리 나는 구역질과 숨 못 쉬는 질식은 다르며, 숨이 막히면 즉시 응급 대응하세요',
        lead: '교육을 미리 받는 편이 좋습니다.',
        points: [
            ['구분', '소리·기침 여부'],
            ['응급', '무음성, 청색']
        ],
    ...
    {
        id: 'infant-choking-class-interval-boundary',
        match: /((영아\s*질식\s*교육\s*주기|질식\s*처치\s*재교육|infant\s*choking\s*class\s*interval))/,
        title: '영아 질식·심폐소생 교육은 재교육으로 유지하고 응급 시 119를 우선하세요',
        lead: '유튜브만으로 충분하다고 보지 마세요.',
        points: [
            ['준비', '공인 교육'],
            ['응급', '119']
        ],
    ...
    {
        id: 'run-while-eating-boundary',
        match: /(식사\s*중\s*뛰어다니기|뛰어다니며\s*먹|run\s*while\s*eating)/,
        title: '식사 중 뛰어다니며 먹지 않게 앉혀 먹이세요',
        lead: '질식 위험이 커집니다.',
        points: [
            ['지금', '앉아서 천천히'],
            ['주의', '달리며 먹이기']
    ...
    {
        id: 'chugging-water-choke-boundary',
        match: /(식사\s*중\s*물\s*급히|물\s*급히\s*마시다\s*사레|chugging\s*water\s*choke)/,
        title: '식사 중 물을 급히 들이키게 두지 말고 앉아서 천천히 마시게 하세요',
        lead: '사레·질식을 조심하세요.',
        points: [
            ['지금', '천천히·앉아서'],
            ['주의', '뛰어다니며 마시기']
    ...
    {
        id: 'egg-yolk-white-order-boundary',
        match: /(계란\s*노른자\s*흰자|계란\s*노른자\s*먼저|흰자\s*알레르기\s*도입|egg\s*yolk\s*white\s*order)/,
        title: '계란 도입 순서·형태는 최신 의료진 안내를 따르고, 즉시 반응이면 진료하세요',
        lead: '과거 통념과 다를 수 있습니다. 여기서 단정하지 않습니다.',
        points: [
            ['상담', '의료진 계획'],
            ['응급', '호흡·전신 반응']
        ],
    ...
    {
        id: 'peanut-introduce-form-boundary',
        match: /(땅콩\s*도입\s*형태|땅콩\s*도입\s*형태|peanut\s*introduce\s*form)/,
        title: '땅콩 도입은 버터를 얇게 바르는 등 형태를 지키고 통 땅콩은 피하세요',
        lead: '고위험군은 의료진 계획이 우선입니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '얇게·섞기'],
            ['주의', '통 견과']
        ],
    ...
    {
        id: 'almond-milk-under-two-boundary',
        match: /(아몬드\s*밀크\s*돌\s*전|아몬드\s*밀크\s*돌\s*전|두유\s*주된\s*음료\s*유아|almond\s*milk\s*toddler\s*main)/,
        title: '돌 전후 식물성 음료를 주된 영양원으로 쓰지 말고 의료진과 상담하세요',
        lead: '제품 순위는 하지 않습니다. 알레르기·영양을 함께 봅니다.',
        points: [
            ['원칙', '주된 음료 아님'],
            ['상담', '특수 식단']
        ],
        blocks: [
            ['지금 할 일', '성분·연령 표시를 확인하세요.'],
            ['하지 않을 일', '우유 대체로 임의 전환하지 마세요.'],
            ['관련', '식물성 음료 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
    ...
    {
        id: 'cow-milk-under-one-boundary',
        match: /(돌\s*전\s*생우유|돌\s*전\s*생우유|12개월\s*전\s*우유|cow\s*milk\s*under\s*one)/,
        title: '돌 전에는 생우유를 주된 음료로 주지 않는 것이 일반 안내입니다',
        lead: '특수한 의료 지시는 예외일 수 있습니다.',
        points: [
            ['원칙', '돌 이후 전환 검토'],
            ['대안', '모유·분유 계획']
        ],
        blocks: [
            ['지금 할 일', '의료진과 전환 시점을 상의하세요.'],
            ['하지 않을 일', '돌 전 생우유를 많이 주지 마세요.'],
            ['관련', '생우유 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
            ['수유 가이드', 'blog/breastfeeding-formula-guide.html']
        ]
    },
    {
        id: 'cow-milk-overintake-boundary',
        match: /(돌\s*이후\s*우유\s*과다|우유\s*과다|cow\s*milk\s*overintake)/,
        title: '돌 이후에도 생우유를 과도하게 주면 철분 등에 영향이 있을 수 있어 양을 조절하세요',
        lead: '정확한 상한은 의료진·표준 안내를 보세요. 여기서 숫자를 단정하지 않습니다.',
        points: [
            ['지금', '균형 식단'],
            ['주의', '우유만 과다']
        ],
    ...
    {
        id: 'solid-readiness-cues-boundary',
        match: /(이유식\s*시작\s*신호|이유식\s*시작\s*신호|이유식\s*준비\s*신호|solid\s*readiness\s*cues)/,
        title: '이유식 시작은 개월 수만이 아니라 목 가누기·관심·삼킴 신호를 함께 보세요',
        lead: '개인차가 있습니다. 알레르기 고위험은 의료진을 상담하세요.',
        points: [
            ['신호', '앉기 지지, 관심'],
            ['금지', '억지 강요']
        ],
        blocks: [
            ['지금 할 일', '신호를 기록해 진료에 가져가세요.'],
            ['하지 않을 일', '누워 먹이지 마세요.'],
            ['관련', '이유식 시작 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'allergen-food-diary-boundary',
        match: /(이유식\s*알레르기\s*기록|이유식\s*알레르기\s*기록|새\s*음식\s*일기|allergen\s*food\s*diary)/,
        title: '새 음식 도입 시 날짜·반응을 기록하면 진료에 도움이 됩니다',
        lead: '즉시 호흡 곤란·전신 두드러기는 응급입니다. 사진 병명 단정은 하지 않습니다.',
        points: [
            ['기록', '음식, 시간, 증상'],
            ['응급', '호흡, 부종']
        ],
        blocks: [
            ['지금 할 일', '한 번에 여러 고위험 식품을 몰아 넣지 마세요.'],
            ['하지 않을 일', '반응을 숨기지 마세요.'],
            ['관련', '알레르기 도입 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'solid-start-month-myth-boundary',
        match: /(이유식\s*시작\s*개월\s*단정|이유식\s*시작\s*개월|solid\s*start\s*month\s*myth)/,
        title: '이유식 시작을 한 개월 숫자만으로 단정하지 말고 준비 신호를 함께 보세요',
        lead: '고위험 알레르기는 의료진 계획을 따르세요.',
        points: [
            ['지금', '신호·상담'],
            ['주의', '개월만 고집']
        ],
        blocks: [
            ['지금 할 일', '목 가누기·관심을 확인하세요.'],
            ['하지 않을 일', '누워 먹이지 마세요.'],
            ['관련', '이유식 시작 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'one-more-bite-pressure-boundary',
        match: /(한입만\s*더\s*강요|한\s*입만\s*더\s*강요|밥\s*남기면\s*안돼\s*강요|one\s*more\s*bite\s*pressure)/,
        title: '한 입만 더 강요는 식사 스트레스를 키울 수 있어 피하고 포만 신호를 존중하세요',
        lead: '성장 부진이 걱정되면 진료하세요.',
        points: [
            ['태도', '강요 최소화'],
            ['관찰', '성장, 수분']
        ],
        blocks: [
            ['지금 할 일', '식사를 짧게 끝내 보세요.'],
            ['하지 않을 일', '밤늦게 먹이기 전쟁을 하지 마세요.'],
            ['관련', '편식·강요 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
    ...
    {
        id: 'solid-refusal-period-boundary',
        match: /(이유식\s*거부\s*기간|이유식\s*거부\s*기간|이유식\s*파업|solid\s*refusal\s*period)/,
        title: '이유식 거부가 며칠 이어져도 수분·수유·성장을 보고, 강요 전쟁을 피하세요',
        lead: '체중 감소·탈수면 진료하세요.',
        points: [
            ['관찰', '소변, 체중'],
            ['피하기', '장시간 강요']
        ],
        blocks: [
            ['지금 할 일', '같은 음식을 여러 번 부드럽게 노출하세요.'],
            ['하지 않을 일', '안 먹는다고 벌을 주지 마세요.'],
            ['관련', '거부 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
    ...
    {
        id: 'picky-food-bribe-boundary',
        match: /(편식\s*보상\s*음식|편식\s*보상\s*디저트|안\s*먹으면\s*간식\s*보상|picky\s*food\s*bribe)/,
        title: '편식에 디저트 보상만 반복하면 식습관이 왜곡될 수 있어 강요·뇌물 균형을 조절하세요',
        lead: '성장 부진이 걱정되면 진료하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['접근', '반복 노출, 함께 먹기'],
            ['피하기', '처벌, 과도한 뇌물']
        ],
        blocks: [
            ['지금 할 일', '같은 음식을 부드럽게 다시 내보세요.'],
            ['하지 않을 일', '밥 전쟁을 밤늦게까지 하지 마세요.'],
            ['관련', '편식 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
    ...
    {
        id: 'youtube-before-sleep-boundary',
        match: /(잠들기\s*전\s*유튜브\s*끄기)/,
        title: '잠들기 전 유튜브를 끄고 잔잔한 루틴으로 바꾸세요',
        lead: '앱 순위는 하지 않습니다.',
        points: [
            ['지금', '화면 끄기·루틴'],
            ['주의', '침대 영상']
    ...
    {
        id: 'child-youtube-account-boundary',
        match: /((아이\s*유튜브\s*계정|키즈\s*계정\s*유튜브|child\s*youtube\s*account))/,
        title: '아이 영상 계정은 보호자가 관리하고 시청 기록·추천을 점검하세요',
        lead: '앱 순위는 하지 않습니다. 자동재생을 끄세요.',
        points: [
            ['관리', '보호자 계정, 시간'],
            ['금지', '방치 시청']
        ],
        blocks: [
            ['지금 할 일', '함께 보며 시간을 정하세요.'],
    ...
    {
        id: 'worksheet-video-homework-boundary',
        match: /(학습지\s*영상\s*숙제|학습지\s*영상\s*숙제|온라인\s*학습지\s*아이|worksheet\s*video\s*homework)/,
        title: '학습 영상이라도 시간을 정하고 실제 조작·대화 숙제를 균형 있게 하세요',
        lead: '앱·학습지 순위는 하지 않습니다.',
        points: [
            ['균형', '시간 제한, 함께 보기'],
            ['우선', '실제 놀이']
        ],
        blocks: [
            ['지금 할 일', '하루 사용 시간을 정하세요.'],
            ['하지 않을 일', '영상이면 무제한으로 두지 마세요.'],
            ['관련', '스크린 안내를 참고하세요.']
        ],
        links: [
            ['AAP 미디어', 'https://www.healthychildren.org/English/family-life/Media/Pages/default.aspx'],
    ...
    {
        id: 'parent-phone-at-meals-boundary',
        match: /(식사\s*중\s*부모\s*폰|식사\s*중\s*부모\s*폰|밥상\s*휴대폰\s*부모|parent\s*phone\s*at\s*meals)/,
        title: '식사 중 부모 휴대폰은 아이 상호작용을 줄일 수 있어 내려놓는 습관을 검토하세요',
        lead: '완벽할 필요는 없습니다.',
        points: [
            ['습관', '식사 때 내려놓기'],
            ['대안', '대화']
        ...
        blocks: [
            ['지금 할 일', '식탁에서 폰을 치워 보세요.'],
            ['하지 않을 일', '아이와 눈을 맞추며 먹어 보세요.'],
            ['관련', '스크린·식사 안내를 참고하세요.']
        ],
        links: [
            ['AAP 미디어', 'https://www.healthychildren.org/English/family-life/Media/Pages/default.aspx'],
    ...
    {
        id: 'screens-off-before-bed-boundary',
        match: /(취침\s*전\s*화면\s*30분|취침\s*전\s*화면\s*끄기|자기\s*전\s*유튜브\s*금지|screens\s*off\s*before\s*bed)/,
        title: '취침 전 화면을 끄고 잔잔한 루틴으로 바꾸면 수면에 도움이 될 수 있습니다',
        lead: '정확한 분 수 단정보다 습관이 중요합니다. 앱 순위는 하지 않습니다.',
        points: [
            ['습관', '화면 끄기, 루틴'],
            ['피하기', '침대에서 영상']
        ],
        blocks: [
            ['지금 할 일', '잠자리 전 책을 읽어 보세요.'],
            ['하지 않을 일', '불을 켠 채 긴 영상을 보지 마세요.'],
            ['관련', '스크린·수면 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'youtube-autoplay-off-boundary',
        match: /(유튜브\s*자동재생\s*끄기|유튜브\s*자동재생\s*끄기|키즈\s*자동재생|youtube\s*autoplay\s*off)/,
        title: '유튜브 자동재생을 끄고 시청 시간을 정해 함께 보세요',
        lead: '교육용이라도 긴 시청은 줄이세요. 앱 순위는 하지 않습니다.',
        points: [
            ['설정', '자동재생 끄기'],
            ['관리', '시간 제한']
        ],
        blocks: [
            ['지금 할 일', '함께 보며 내용을 이야기하세요.'],
            ['하지 않을 일', '배경으로 종일 틀지 마세요.'],
            ['관련', '스크린·유튜브 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'video-call-grandparent-boundary',
        match: /(영상\s*통화\s*할머니|영상\s*통화\s*할머니|video\s*call\s*grandparent)/,
        title: '할머니와 영상 통화는 짧게 상호작용으로 쓰고 종일 배경 화면으로 두지 마세요',
        lead: '앱 순위는 하지 않습니다.',
        points: [
            ['지금', '짧게·함께'],
            ['주의', '종일 틀기']
    ...
    {
        id: 'parent-scroll-in-front-boundary',
        match: /(아이\s*앞\s*부모\s*스크롤|아이\s*앞\s*스크롤|parent\s*scroll\s*front)/,
        title: '아이와 놀 때 부모가 계속 스크롤하면 상호작용이 줄 수 있어 의식적으로 내려놓으세요',
        lead: '완벽할 필요는 없습니다.',
        points: [
            ['지금', '놀이 때 내려놓기'],
            ['주의', '계속 스크롤']
        ...
        blocks: [
            ['지금 할 일', '중요한 순간은 함께 보세요.'],
            ['하지 않을 일', '아이 앞에서 계속 폰만 보지 마세요.'],
            ['관련', '스크린 안내를 참고하세요.']
        ],
        links: [
            ['AAP 미디어', 'https://www.healthychildren.org/English/family-life/Media/Pages/default.aspx'],
    ...
    {
        id: 'constipation-tummy-massage-boundary',
        match: /(변비\s*배\s*마사지|변비\s*배\s*마사지|배변\s*안돼\s*배\s*문지르|constipation\s*tummy\s*massage)/,
        title: '변비에 부드러운 배 마사지는 시도할 수 있으나 통증·혈변이면 진료하세요',
        lead: '관장·약은 의료진을 따르세요.',
        points: [
            ['기본', '수분, 섬유, 활동'],
            ['진료', '심한 통증, 혈변']
        ],
    ...
    {
        id: 'constipation-potty-posture-boundary',
        match: /(변비\s*배변\s*자세|변비\s*배변\s*자세|변기\s*발\s*디딤\s*변비|constipation\s*potty\s*posture)/,
        title: '변비에 발 디딤 자세는 도움이 될 수 있으나 통증·혈변이면 진료하세요',
        lead: '약·관장은 의료진을 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['기본', '수분, 섬유, 활동'],
            ['진료', '심한 통증, 혈변']
        ],
    ...
    {
        id: 'constipation-painful-stool-boundary',
        match: /(변비\s*배변\s*통증|변비\s*통증\s*배변|constipation\s*painful\s*stool)/,
        title: '배변이 아프고 피가 보이면 진료를 검토하고 임의 관장을 반복하지 마세요',
        lead: '약 용량은 의료진을 따르세요.',
        points: [
            ['지금', '수분·섬유·진료'],
            ['주의', '억지 관장 반복']
        ],
    ...
    {
        id: 'reward-only-motivation-boundary',
        match: /(보상\s*없으면\s*안\s*해|보상\s*없으면\s*안\s*해|스티커\s*없으면\s*안함|reward\s*only\s*motivation)/,
        title: '보상에만 의존하면 동기가 약해질 수 있어 구체적 칭찬과 규칙을 함께 쓰세요',
        lead: '물질 보상 과다를 피하세요.',
        points: [
            ['균형', '칭찬, 규칙'],
            ['피하기', '모든 행동 보상']
    ...
    {
        id: 'sticker-chart-simple-goal-boundary',
        match: /(보상\s*스티커\s*목표|보상\s*스티커\s*목표|스티커\s*차트\s*간단히|sticker\s*chart\s*simple\s*goal)/,
        title: '스티커 보상은 목표를 단순하게 짧게 쓰고 모든 행동을 보상으로 바꾸지 마세요',
        lead: '제품 순위는 하지 않습니다.',
        points: [
            ['사용', '짧은 목표, 구체 칭찬'],
            ['피하기', '과도한 물질 보상']
    ...
    {
        id: 'praise-without-reward-boundary',
        match: /(보상\s*없이\s*칭찬|보상\s*없이\s*칭찬|praise\s*without\s*reward)/,
        title: '물질 보상 없이도 구체적 행동 칭찬으로 동기를 도울 수 있습니다',
        lead: '모든 행동을 보상으로만 바꾸지 마세요.',
        points: [
            ['지금', '구체적 칭찬'],
            ['주의', '과다 물질 보상']
        ],
    ...
    {
        id: 'timeout-explain-after-boundary',
        match: /(타임아웃\s*설명\s*후|타임아웃\s*후\s*설명|반성\s*후\s*이야기|timeout\s*explain\s*after)/,
        title: '타임아웃이 끝나면 짧게 기대 행동을 말하고 길게 설교하지 마세요',
        lead: '어두운 감금은 하지 마세요.',
        points: [
            ['방법', '짧게, 안전 장소'],
            ['이후', '짧은 설명']
    ...
    {
        id: 'timeout-chair-safe-boundary',
        match: /(타임아웃\s*의자\s*고정|타임아웃\s*의자\s*안전|반성\s*의자\s*고정|timeout\s*chair\s*safe)/,
        title: '타임아웃은 안전한 의자·장소에서 짧게 하고 묶거나 가두지 마세요',
        lead: '어두운 감금은 하지 마세요.',
        points: [
            ['원칙', '짧게, 안전'],
            ['금지', '묶기, 장시간']
    ...
    {
        id: 'timeout-age-fit-boundary',
        match: /(타임아웃\s*연령|타임아웃\s*연령|timeout\s*age\s*fit)/,
        title: '타임아웃은 이해 가능한 연령·짧게 쓰고 장시간 감금은 하지 마세요',
        lead: '분 수를 여기서 단정하지 않고 원칙을 안내합니다.',
        points: [
            ['지금', '짧게·안전 장소'],
            ['주의', '어두운 감금']
        ],
    ...
    {
        id: 'public-floor-tantrum-boundary',
        match: /(공공장소\s*바닥에\s*드러눕기|마트\s*바닥\s*드러눕|공공\s*바닥\s*떼|public\s*floor\s*tantrum)/,
        title: '공공장소 바닥 떼쓰기에는 안전을 먼저 보고 짧고 차분히 대응하세요',
        lead: '체벌·수치심 주기는 피하세요.',
        points: [
            ['우선', '안전, 이동'],
            ['피하기', '체벌']
        ],
        blocks: [
            ['지금 할 일', '위험하면 장소를 옮기세요.'],
            ['하지 않을 일', '때리거나 소리로 제압하지 마세요.'],
            ['관련', '떼쓰기 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'hitting-stop-immediately-boundary',
        match: /(때리기\s*바로\s*막기|아이\s*때리기\s*막|때리면\s*바로|hitting\s*stop\s*immediately)/,
        title: '때리기·물기는 즉시 막고 짧게 안 된다고 말한 뒤 대안을 가르치세요',
        lead: '맞받아 때리기는 피하세요.',
        points: [
            ['즉시', '막기, 짧게 말'],
            ['대안', '말로 표현']
    ...
    {
        id: 'hitting-apology-teach-boundary',
        match: /(때린\s*뒤\s*사과\s*가르치기|때린\s*뒤\s*사과|hitting\s*apology)/,
        title: '때린 뒤에는 짧게 안 된다고 막고 아픔을 알려 주며 사과를 가르치세요',
        lead: '맞받아 때리기는 피하세요.',
        points: [
            ['지금', '즉시 막기·짧게 말'],
            ['주의', '맞받아 때리기']
    ...
    {
        id: 'overnight-diaper-rash-boundary',
        match: /(기저귀\s*발진\s*밤|밤새\s*기저귀\s*발진|야간\s*기저귀\s*진물|overnight\s*diaper\s*rash)/,
        title: '밤사이 발진이 심하면 흡수 좋은 교체·통풍·보호막을 검토하고 감염 징후면 진료하세요',
        lead: '크림 브랜드 순위·용량 단정은 하지 않습니다.',
        points: [
            ['관리', '자주 확인, 건조'],
            ['진료', '진물, 열, 확산']
        ],
        blocks: [
            ['지금 할 일', '밤에 한 번 더 확인해 보세요.'],
            ['하지 않을 일', '사진으로 병명을 단정하지 마세요.'],
            ['관련', '기저귀 발진 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'diaper-yeast-vs-rash-boundary',
        match: /(기저귀\s*발진\s*vs\s*효모)/,
        title: '살주름·점이 찍힌 발진은 일반 발진과 다를 수 있어 사진 단정 대신 진료를 검토하세요',
        lead: '약 처방은 의료진을 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['관찰', '위치, 진물, 기간'],
            ['금지', '사진 병명']
        ],
    ...
    {
        id: 'pet-allergy-med-boundary',
        match: /(펫\s*알레르기\s*약|펫\s*알레르기\s*약|반려동물\s*알레르기\s*항히|pet\s*allergy\s*medicine)/,
        title: '펫 알레르기 약은 의료진 처방·표시를 따르고 용량을 여기서 정하지 마세요',
        lead: '호흡 곤란은 응급입니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['상담', '진단, 처방'],
            ['응급', '호흡 곤란']
        ],
    ...
    {
        id: 'hives-widespread-boundary',
        match: /(두드러기\s*전체|두드러기\s*전신|온몸\s*두드러기\s*아이|hives\s*widespread\s*child)/,
        title: '전신 두드러기와 호흡·부종이 있으면 응급 진료를 우선하세요',
        lead: '원인 단정은 의료진이 합니다. 약 용량은 여기서 정하지 않습니다.',
        points: [
            ['응급', '호흡, 얼굴 부종'],
            ['기록', '음식·환경']
        ],
        blocks: [
            ['지금 할 일', '증상을 시간순으로 적으세요.'],
    ...
    {
        id: 'food-allergy-rechallenge-boundary',
        match: /(음식\s*알레르기\s*재시도|음식\s*알레르기\s*재시도|알레르기\s*음식\s*다시|food\s*allergy\s*rechallenge)/,
        title: '알레르기 의심 음식 재시도는 의료진 계획 없이 집에서 하지 마세요',
        lead: '응급 시 호흡·부종을 우선하세요.',
        points: [
            ['원칙', '의료진 계획'],
            ['응급', '호흡, 전신 두드러기']
        ],
    ...
    {
        id: 'hives-food-suspect-boundary',
        match: /(두드러기\s*음식\s*의심|두드러기\s*음식\s*의심|hives\s*food\s*suspect)/,
        title: '두드러기 후 음식 의심이 있으면 기록을 남기고 의료진과 상의하세요',
        lead: '호흡·부종은 응급입니다. 재시도는 의료진 계획 없이 하지 마세요.',
        points: [
            ['지금', '기록·상담'],
            ['주의', '집에서 재시도']
        ],
    ...
    {
        id: 'eczema-bath-length-boundary',
        match: /(아토피\s*목욕\s*시간|아토피\s*목욕\s*시간|습진\s*긴\s*목욕|eczema\s*bath\s*length)/,
        title: '습진·건조 피부는 너무 뜨겁고 긴 목욕을 피하고 직후 보습을 검토하세요',
        lead: '약 처방은 의료진을 따르세요. 제품 순위는 하지 않습니다.',
        points: [
            ['방법', '미지근, 짧게, 보습'],
            ['피하기', '뜨거운 물 장시간']
        ],
    ...
    {
        id: 'poison-ivy-clothes-wash-boundary',
        match: /(옻\s*옷\s*세탁|옻\s*옷\s*세탁|poison\s*ivy\s*clothes\s*wash|덩굴옻\s*옷)/,
        title: '옻 접촉 옷은 따로 세탁하고 피부를 비누로 씻으세요',
        lead: '연기를 마시며 태우지 마세요.',
        points: [
            ['조치', '피부·옷 세척'],
            ['진료', '심한 발진, 얼굴']
        ],
    ...
    {
        id: 'hfmd-mouth-pain-hydration-boundary',
        match: /(수족구\s*입안\s*통증\s*수분|수족구\s*입안\s*통증\s*수분|수족구\s*잘\s*못\s*먹|hfmd\s*mouth\s*pain\s*drink)/,
        title: '수족구로 입안이 아파 수분 섭취가 줄면 탈수를 보고 심하면 진료하세요',
        lead: '등원 시기는 시설·의료진 안내를 따르세요. 약 용량은 단정하지 않습니다.',
        points: [
            ['관찰', '소변, 처짐'],
            ['도움', '시원, 부드러운 음식']
        ],
    ...
    {
        id: 'hfmd-toy-clean-boundary',
        match: /(수족구\s*장난감\s*소독|수족구\s*장난감\s*소독|수족구\s*장난감\s*닦|hfmd\s*toy\s*clean)/,
        title: '수족구가 돌 때는 공용 장난감·수건 위생을 강화하고 손 씻기를 하세요',
        lead: '등원 시기는 시설·의료진 안내를 따르세요.',
        points: [
            ['위생', '손, 장난감'],
            ['등원', '규정']
        ],
    ...
    {
        id: 'hfmd-hydration-priority-boundary',
        match: /(수족구\s*수분\s*섭취|수족구\s*수분|hfmd\s*hydration)/,
        title: '수족구로 입안이 아프면 수분 섭취를 우선하고 탈수 신호를 보세요',
        lead: '등원 시기는 시설·의료진 안내를 따르세요.',
        points: [
            ['지금', '수분·탈수 관찰'],
            ['주의', '억지 식사']
    ...
    {
        id: 'rash-photo-for-clinic-boundary',
        match: /(발진\s*사진\s*병원|발진\s*사진\s*병원|발진\s*찍어\s*진료|rash\s*photo\s*for\s*clinic)/,
        title: '발진 사진은 진료 보조로 쓸 수 있으나 사진만으로 병명을 정하지 마세요',
        lead: '호흡 곤란·전신 증상은 응급입니다.',
        points: [
            ['기록', '발생 시점, 사진'],
            ['금지', '사진 단정·이웃 연고']
        ],
    ...
    {
        id: 'rash-with-fever-boundary',
        match: /(발진\s*열\s*동반|발진\s*열\s*동반|rash\s*with\s*fever)/,
        title: '발진과 열이 같이 있으면 사진 단정 대신 전신 상태와 진료를 보세요',
        lead: '호흡 곤란·처짐은 응급입니다.',
        points: [
            ['지금', '열·처짐·호흡'],
            ['주의', '사진 병명']
        ],
    ...
    {
        id: 'car-sickness-front-seat-boundary',
        match: /(차\s*멀미\s*앞좌석|차\s*멀미\s*앞좌석|멀미\s*조수석\s*아이|car\s*sickness\s*front\s*seat)/,
        title: '차멀미에 앞좌석은 에어백·연령 규정을 우선하고 의료진·법을 확인하세요',
        lead: '뒷좌석이 안전한 경우가 많습니다. 약 용량은 단정하지 않습니다.',
        points: [
            ['우선', '안전 규정'],
            ['환경', '환기, 시야']
        ],
    ...
    {
        id: 'car-sickness-bag-boundary',
        match: /(차\s*멀미\s*봉투|차\s*멀미\s*봉투|멀미\s*토\s*봉투|car\s*sickness\s*bag)/,
        title: '차멀미에는 환기·시야·가벼운 식사를 돕고 약은 의료진과 상의하세요',
        lead: '용량 단정·브랜드 순위는 하지 않습니다.',
        points: [
            ['환경', '환기, 앞 시야'],
            ['피하기', '화면, 과식']
    ...
    {
        id: 'reflux-burp-then-sleep-boundary',
        match: /(역류\s*트림\s*후\s*재우기|역류\s*트림\s*후\s*재우|토하고\s*바로\s*재우|reflux\s*burp\s*sleep)/,
        title: '역류·토함 후에는 트림과 안정 후 등 평평한 수면을 우선하세요',
        lead: '경사 수면 제품은 위험할 수 있습니다.',
        points: [
            ['수면', '등, 평평'],
            ['금지', '카시트·소파 수면']
        ],
    ...
    {
        id: 'honey-tea-under-one-boundary',
        match: /(돌\s*전\s*꿀\s*차|돌\s*전\s*꿀\s*차|꿀물\s*아기|honey\s*tea\s*under\s*one)/,
        title: '돌 전 아기에게 꿀이 든 차·물을 주지 마세요',
        lead: '보툴리눔 위험 때문입니다.',
        points: [
            ['금지', '돌 전 꿀'],
            ['확인', '성분']
    ...
    {
        id: 'wrist-test-baby-food-boundary',
        match: /(데운\s*이유식\s*손목\s*온도|이유식\s*손목\s*온도|데운\s*음식\s*손목|wrist\s*test\s*baby\s*food)/,
        title: '데운 이유식은 잘 저은 뒤 손목 안쪽으로 온도를 확인하세요',
        lead: '뜨거운 반점 화상을 조심하세요.',
        points: [
            ['방법', '젓기, 온도 확인'],
            ['금지', '바로 입']
        ],
    ...
    {
        id: 'thermos-lunch-safety-boundary',
        match: /(보온\s*도시락\s*식중독)/,
        title: '보온·보냉 도시락도 오래 방치하지 말고 온도 유지를 확인하세요',
        lead: '더운 날 위험이 큽니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['온도', '뜨겁게/차갑게 유지'],
            ['폐기', '이상 냄새']
        ],
        blocks: [
            ['지금 할 일', '아이스팩·예열을 검토하세요.'],
            ['하지 않을 일', '몇 시간 지난 의심 음식을 주지 마세요.'],
            ['관련', '도시락 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
    ...
    {
        id: 'baby-food-reheat-once-boundary',
        match: /(이유식\s*재가열\s*횟수|이유식\s*재가열\s*횟수|데운\s*이유식\s*다시|baby\s*food\s*reheat\s*once)/,
        title: '데운 이유식은 남은 것을 반복 재가열하지 말고 위생적으로 처리하세요',
        lead: '정확한 보관 시간은 재료·안내를 따르세요.',
        points: [
            ['원칙', '필요량만 데우기'],
            ['폐기', '이상 냄새']
        ],
        blocks: [
            ['지금 할 일', '한 번에 먹을 양만 데우세요.'],
            ['하지 않을 일', '상온에 오래 둔 것을 다시 주지 마세요.'],
            ['관련', '방치 음식 안내를 참고하세요.']
        ],
        links: [
            ['AAP 영양', 'https://www.healthychildren.org/English/healthy-living/nutrition/Pages/default.aspx'],
    ...
    {
        id: 'mixed-formula-left-out-boundary',
        match: /(분유\s*탄\s*후\s*방치|분유\s*탄\s*후\s*방치|mixed\s*formula\s*left\s*out)/,
        title: '조유한 분유를 상온에 오래 두지 말고 안내 시간에 맞게 폐기하세요',
        lead: '정확한 시간은 제품·기관 안내를 따르세요.',
        points: [
            ['지금', '위생·시간'],
            ['주의', '장시간 상온']
        ],
    ...
    {
        id: 'night-formula-prep-hygiene-boundary',
        match: /(분유\s*밤중\s*조유|밤중\s*분유\s*조유|밤에\s*분유\s*타|night\s*formula\s*prep)/,
        title: '밤중 분유 조유도 위생·표시 비율을 지키고 과희석하지 마세요',
        lead: '제품 표시를 따릅니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '손 위생, 표시 비율'],
            ['금지', '과희석']
        ],
        blocks: [
            ['지금 할 일', '미리 준비할 때도 위생을 지키세요.'],
            ['하지 않을 일', '표시보다 묽게 타지 마세요.'],
            ['관련', '분유 조유 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'jaundice-eye-white-boundary',
        match: /(황달\s*눈\s*흰자|황달\s*눈\s*흰자|눈\s*흰자\s*노란|jaundice\s*sclera)/,
        title: '눈 흰자가 노랗게 보이면 사진 단정 대신 진료·추적 검사를 검토하세요',
        lead: '황달은 시기·수치가 중요합니다.',
        points: [
            ['관찰', '수유, 소변, 처짐'],
            ['행동', '재검 일정']
        ],
        blocks: [
            ['지금 할 일', '퇴원 재방문 일자를 지키세요.'],
            ['하지 않을 일', '사진 비교로 괜찮다고 단정하지 마세요.'],
            ['관련', '황달 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'parenting-burnout-shift-boundary',
        match: /(육아\s*번아웃\s*교대)/,
        title: '육아 소진이 심하면 교대·휴식을 요청하고 위기면 정신건강 자원을 이용하세요',
        lead: '아이 정보보다 보호자 안전이 우선일 수 있습니다.',
        points: [
            ['즉시', '교대, 도움'],
            ['위험', '자해·아이 위험 생각']
        ],
    ...
    {
        id: 'parent-guilt-boundary',
        match: /(육아\s*죄책감|육아\s*죄책감|엄마\s*죄책감|parent\s*guilt\s*childcare)/,
        title: '육아 죄책감이 심하면 완벽 기준을 낮추고 도움을 요청하세요',
        lead: '우울·불안이 크면 상담 자원을 연결하세요.',
        points: [
            ['즉시', '도움, 휴식'],
            ['위험', '자해 생각']
        ],
    ...
    {
        id: 'postpartum-mood-check-boundary',
        match: /(산후\s*우울\s*자가\s*점검|산후\s*우울\s*자가\s*점검|산후우울\s*체크|postpartum\s*mood\s*check)/,
        title: '산후 기분 저하가 지속되면 자가 판단에 맡기지 말고 상담·진료를 연결하세요',
        lead: '위기면 응급·정신건강 자원을 이용하세요.',
        points: [
            ['연결', '상담, 진료'],
            ['위험', '자해·아이 위험 생각']
    ...
    {
        id: 'parent-overwhelm-help-boundary',
        match: /(육아\s*울분\s*도움|육아\s*울분|양육\s*한계\s*도움|parent\s*overwhelm\s*help)/,
        title: '육아가 한계에 달하면 아이 정보보다 도움을 먼저 연결하세요',
        lead: '위기면 응급·정신건강 자원을 이용하세요.',
        points: [
            ['즉시', '교대, 도움 요청'],
            ['위험', '자해·아이 위험 생각']
    ...
    {
        id: 'ask-for-parenting-help-boundary',
        match: /(육아\s*도움\s*요청|육아\s*도움\s*요청|ask\s*for\s*parenting\s*help)/,
        title: '육아가 힘들면 도움을 요청하는 것이 아이와 보호자 모두에게 중요합니다',
        lead: '위기면 응급·정신건강 자원을 이용하세요.',
        points: [
            ['지금', '교대·상담'],
            ['주의', '혼자 감내']
    ...
    {
        id: 'parent-isolation-help-boundary',
        match: /(육아\s*고립감|육아\s*고립|parent\s*isolation)/,
        title: '육아 고립감이 심하면 도움을 요청하고 상담 자원을 연결하세요',
        lead: '위기면 응급·정신건강 경로를 이용하세요.',
        points: [
            ['지금', '도움 요청'],
            ['주의', '혼자 감내']
        ],
    ...
    {
        id: 'daycare-gastro-outbreak-boundary',
        match: /(어린이집\s*장염\s*유행)/,
        title: '어린이집 장염 유행 시 손 씻기와 등원 기준을 지키고 탈수 신호를 보세요',
        lead: '복귀 시기는 시설·의료진 안내를 따르세요.',
        points: [
            ['위생', '손 씻기'],
            ['등원', '규정 준수']
        ],
        blocks: [
            ['지금 할 일', '집에 와서 손을 씻기세요.'],
            ['하지 않을 일', '토·설사가 있으면 무리해 보내지 마세요.'],
            ['관련', '장염·등원 안내를 참고하세요.']
        ],
        links: [
            ['CDC 위생', 'https://www.cdc.gov/hygiene/'],
    ...
    {
        id: 'diarrhea-sports-drink-boundary',
        match: /(설사\s*스포츠음료|설사\s*스포츠\s*음료|장염\s*이온\s*음료|diarrhea\s*sports\s*drink)/,
        title: '설사 때 일반 스포츠음료보다 ORS·의료진 안내를 우선하세요',
        lead: '브랜드 순위·용량 단정은 하지 않습니다.',
        points: [
            ['우선', 'ORS·수분 계획'],
            ['주의', '당 많은 음료']
        ],
        blocks: [
            ['지금 할 일', '탈수 신호를 보세요.'],
            ['하지 않을 일', '성인 이온음료를 임의로 다량 주지 마세요.'],
            ['관련', '설사·ORS 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'diarrhea-dairy-restart-boundary',
        match: /(설사\s*후\s*유제품|설사\s*후\s*유제품|장염\s*후\s*우유|diarrhea\s*dairy\s*restart)/,
        title: '설사 후 유제품 재개는 의료진 안내와 상태를 보고, 탈수 신호를 우선하세요',
        lead: 'ORS·식단은 상황에 따라 다릅니다.',
        points: [
            ['우선', '수분, 탈수 관찰'],
            ['상담', '지속 설사, 혈변']
        ],
    ...
    {
        id: 'diarrhea-urine-count-boundary',
        match: /(설사\s*소변\s*횟수|설사\s*소변\s*횟수|diarrhea\s*urine\s*count)/,
        title: '설사 때 소변 횟수·처짐을 보고 탈수가 의심되면 진료하세요',
        lead: 'ORS는 안내·의료진을 따르세요. 용량 단정은 하지 않습니다.',
        points: [
            ['지금', '소변·처짐 관찰'],
            ['주의', '수분 거부 방치']
        ],
    ...
    {
        id: 'leftover-antibiotic-boundary',
        match: /(항생제\s*남은\s*것|남은\s*항생제\s*아이|집에\s*남은\s*항생제|leftover\s*antibiotic\s*child)/,
        title: '집에 남은 항생제를 임의로 주지 말고 처방에 따르세요',
        lead: '바이러스 감기에는 필요 없을 수 있습니다.',
        points: [
            ['원칙', '진료 처방'],
            ['금지', '남은 약 재복용']
        ],
        blocks: [
            ['지금 할 일', '증상을 정확히 말하세요.'],
            ['하지 않을 일', '남은 약을 버리지 않고 보관 남용하지 마세요.'],
            ['관련', '항생제 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'swaddle-leg-space-boundary',
        match: /(속싸개\s*다리\s*여유\s*확인)/,
        title: '속싸개 때 다리가 너무 꽉 조이지 않게 여유를 두세요',
        lead: '고관절 여유와 뒤집기 전환을 보세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '다리 여유'],
            ['주의', '일자로 강하게 묶기']
        ],
        blocks: [
            ['지금 할 일', '다리가 구부려지는지 확인하세요.'],
            ['하지 않을 일', '뒤집기 시작하면 팔을 빼세요.'],
            ['관련', '속싸개 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'tummy-time-hate-boundary',
        match: /(터미타임\s*토하고\s*싫어|터미타임\s*싫어|엎드리기\s*거부|tummy\s*time\s*hate)/,
        title: '터미타임을 싫어하면 짧게 자주, 가슴 위 등 변형으로 시도하고 수면 중 엎드림과 혼동하지 마세요',
        lead: '안전수면은 등 재우기입니다.',
        points: [
            ['방법', '짧게, 자주, 감독'],
            ['금지', '잠든 채 엎드림']
        ...
        blocks: [
            ['지금 할 일', '하루 여러 번 짧게 해보세요.'],
            ['하지 않을 일', '혼자 두고 길게 엎드리지 마세요.'],
            ['관련', '터미타임 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'tummy-time-daily-total-boundary',
        match: /(터미타임\s*하루\s*합|터미타임\s*하루\s*합|엎드려\s*놀기\s*총\s*시간|tummy\s*time\s*daily\s*total)/,
        title: '터미타임은 짧게 자주 합산하는 방식이 도움이 될 수 있으며 수면 중 엎드림과 구분하세요',
        lead: '정확한 분 수 단정보다 감독·신호가 중요합니다.',
        points: [
            ['방법', '짧게, 자주, 감독'],
            ['금지', '잠든 채 엎드림']
        ],
        blocks: [
            ['지금 할 일', '하루 여러 번 나눠 해보세요.'],
            ['하지 않을 일', '혼자 두고 길게 엎드리지 마세요.'],
            ['관련', '터미타임 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'tummy-time-mirror-boundary',
        match: /(터미타임\s*거울|터미타임\s*거울|tummy\s*time\s*mirror)/,
        title: '터미타임에 거울은 흥미 유발 보조일 수 있으나 감독과 짧게 자주가 우선입니다',
        lead: '수면 중 엎드림과 구분하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '짧게 자주·감독'],
            ['주의', '잠든 채 엎드림']
        ],
        blocks: [
            ['지금 할 일', '하루 여러 번 나눠 하세요.'],
            ['하지 않을 일', '혼자 두고 길게 엎드리지 마세요.'],
            ['관련', '터미타임 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'toothpaste-flavor-overuse-boundary',
        match: /(치약\s*맛\s*때문에\s*많이|치약\s*맛\s*많이\s*짜|맛있는\s*치약\s*과다|toothpaste\s*flavor\s*overuse)/,
        title: '치약은 연령 안내 분량만 짜고, 맛있다고 많이 짜 먹게 두지 마세요',
        lead: '과다 삼킴이 있으면 상담을 검토하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['분량', '쌀알·콩알 안내'],
            ['보관', '뚜껑 잠금']
        ],
    ...
    {
        id: 'fluoride-varnish-aftercare-boundary',
        match: /(불소\s*바니시\s*후|불소\s*바니시\s*후|불소\s*도포\s*후\s*먹|fluoride\s*varnish\s*after)/,
        title: '불소 바니시 후 식사·양치 안내는 치과 지시를 따르세요',
        lead: '용량·제품은 의료진을 따릅니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['준수', '치과 안내'],
            ['주의', '즉시 양치 여부']
        ],
    ...
    {
        id: 'first-dental-fear-boundary',
        match: /(첫\s*치과\s*공포|치과\s*무서워\s*아이|first\s*dental\s*fear)/,
        title: '첫 치과 방문 전에 짧게 연습하고 강요로 싸우지 마세요',
        lead: '정기 검진 시기는 의료진 안내를 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['준비', '짧게 설명, 역할놀이'],
            ['피하기', '협박']
        ],
        blocks: [
            ['지금 할 일', '장난감으로 입을 열어 보는 놀이를 해보세요.'],
            ['하지 않을 일', '혼내며 끌고 가지 마세요.'],
            ['관련', '첫 치과 안내를 참고하세요.']
        ],
        links: [
            ['치아 가이드', 'blog/baby-dental-care.html'],
    ...
    {
        id: 'night-feed-tooth-decay-boundary',
        match: /(밤중\s*수유\s*치아|밤중\s*수유\s*치아|재우며\s*젖병\s*치아|night\s*bottle\s*tooth)/,
        title: '재우며 젖병·모유를 오래 물리면 치아 위험이 커질 수 있어 수면 중 병을 치우세요',
        lead: '수유 중단 시점은 성장·의료진을 보세요. 용량 단정은 하지 않습니다.',
        points: [
            ['습관', '잠들면 병 제거'],
            ['위생', '잇몸·치아 닦기']
        ],
        blocks: [
            ['지금 할 일', '잠든 뒤 병을 빼 주세요.'],
            ['하지 않을 일', '당 음료를 젖병에 넣어 재우지 마세요.'],
            ['관련', '밤병·양치 안내를 참고하세요.']
        ],
        links: [
            ['치아 가이드', 'blog/baby-dental-care.html'],
    ...
    {
        id: 'carseat-indoor-sleep-boundary',
        match: /(카시트에\s*집\s*안\s*재우|카시트\s*집\s*안\s*재우|실내\s*카시트\s*수면|carseat\s*indoor\s*sleep)/,
        title: '집 안에서 카시트에 재우지 말고 평평한 안전 수면 공간으로 옮기세요',
        lead: '호흡·자세 위험이 있을 수 있습니다.',
        points: [
            ['원칙', '평평한 침대, 등'],
            ['금지', '카시트·유모차 장시간 수면']
        ],
        blocks: [
            ['지금 할 일', '도착 후 침대로 옮기세요.'],
            ['하지 않을 일', '카시트에 방치하지 마세요.'],
            ['관련', '안전수면·카시트 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'inclined-sleeper-ban-remind-boundary',
        match: /(신생아\s*수면\s*경사\s*쿠션\s*금지)/,
        title: '경사 수면 쿠션·인클라인 슬리퍼로 재우지 마세요',
        lead: '평평한 등 재우기와 빈 침대가 안전수면 원칙에 가깝습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '등·평평·빈 침대'],
            ['주의', '경사 제품·소파 수면']
        ],
    ...
    {
        id: 'crib-bumper-remind-boundary',
        match: /(아기\s*침대\s*범퍼\s*치우기)/,
        title: '아기 침대 범퍼·가드는 질식 위험이 있어 쓰지 않는 편이 안전합니다',
        lead: '수면 공간은 비워 두세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '빈 침대'],
            ['주의', '범퍼·인형·헐렁한 이불']
        ],
    ...
    {
        id: 'weighted-sleep-sack-boundary',
        match: /(무게\s*수면\s*조끼|weighted\s*sleep|무게\s*슬립색)/,
        title: '무게 있는 수면 조끼·담요는 영아에게 권장되지 않는 안내가 많습니다',
        lead: '안전수면 원칙을 우선하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '가벼운 수면 조끼 검토'],
            ['주의', '무게 제품 과신']
        ],
        blocks: [
            ['지금 할 일', '제품 연령 표시를 확인하세요.'],
            ['하지 않을 일', '무게 제품으로 재우지 마세요.'],
            ['관련', '수면 제품 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'summer-swaddle-overheat-boundary',
        match: /(신생아\s*속싸개\s*여름|여름\s*속싸개\s*더위|더운\s*날\s*스와들|summer\s*swaddle\s*overheat)/,
        title: '더운 날 속싸개는 과열을 보고 얇은 소재·전환을 검토하세요',
        lead: '뒤집기 시작하면 팔을 빼세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['관찰', '땀, 열감'],
            ['전환', '팔 자유']
        ],
        blocks: [
            ['지금 할 일', '목 뒤 온도를 느껴 보세요.'],
            ['하지 않을 일', '두껍게 싸서 재우지 마세요.'],
            ['관련', '속싸개·과열 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'sleep-headband-infant-boundary',
        match: /(신생아\s*수면\s*헤드밴드|수면\s*헤드밴드\s*아기|아기\s*헤어밴드\s*재우|sleep\s*headband\s*infant)/,
        title: '수면 중 헤드밴드·모자·장식은 질식·과열 위험이 있어 치우세요',
        lead: '안전수면은 등·빈 침대입니다.',
        points: [
            ['수면', '장식 제거'],
            ['원칙', '등 재우기']
        ],
        blocks: [
            ['지금 할 일', '잠들 때 장식을 빼 주세요.'],
            ['하지 않을 일', '느슨한 천을 얼굴 쪽에 두지 마세요.'],
            ['관련', '안전수면 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'flashlight-bedtime-boundary',
        match: /(손전등\s*재우기)/,
        title: '어둠 공포에 손전등은 보조일 수 있으나 수면 위생과 안전(열·낙하)을 보세요',
        lead: '은은한 수면등이 나을 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['환경', '은은한 빛'],
            ['안전', '뜨거운 전등']
        ],
    ...
    {
        id: 'side-sleep-infant-boundary',
        match: /(신생아\s*옆누움\s*재우기|신생아\s*옆누움\s*재우|옆으로\s*재우\s*아기|side\s*sleep\s*infant)/,
        title: '신생아를 옆이나 배로 재우지 말고 등 재우기를 지키세요',
        lead: '뒤집기 시작 후에도 시작은 등입니다. 수면 공간은 비우세요.',
        points: [
            ['원칙', '등 재우기'],
            ['금지', '옆·배 재우기(권장 아님)']
        ],
    ...
    {
        id: 'sleep-plush-infant-boundary',
        match: /(신생아\s*수면\s*공\s*인형|수면\s*공\s*인형\s*아기|아기\s*침대\s*인형|sleep\s*plush\s*infant)/,
        title: '영아 수면 공간에 인형·쿠션을 넣지 마세요',
        lead: '질식 위험이 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '빈 침대'],
            ['금지', '연한 침구']
        ],
    ...
    {
        id: 'sleep-position-sensor-boundary',
        match: /(신생아\s*수면\s*위치\s*센서|수면\s*위치\s*센서|스마트\s*수면\s*패드|sleep\s*position\s*sensor)/,
        title: '수면 센서·스마트 패드는 보조일 뿐이며 안전수면 원칙을 대체하지 않습니다',
        lead: '헐렁한 패드·전선 위험을 보세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '등, 빈 침대'],
            ['경계', '기기 과신']
        ],
    ...
    {
        id: 'newborn-layered-blanket-sleep-boundary',
        match: /(신생아\s*수면\s*싸개\s*담요\s*겹|수면\s*담요\s*여러\s*겹|newborn\s*layered\s*blanket)/,
        title: '신생아 수면 시 담요를 여러 겹 덮지 말고 등 재우기와 빈 침대를 지키세요',
        lead: '과열·질식 위험이 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '등, 빈 침대'],
            ['금지', '헐렁한 침구 겹침']
        ],
    ...
    {
        id: 'indoor-hat-sleep-remind-boundary',
        match: /(신생아\s*수면\s*모자\s*실내|실내\s*모자\s*재우|indoor\s*hat\s*sleep)/,
        title: '실내에서 재울 때 모자는 과열 위험이 있어 보통 쓰지 않는 안내가 많습니다',
        lead: '의료 상황은 의료진을 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '과열 피하기'],
            ['주의', '두꺼운 모자 수면']
        ],
    ...
    {
        id: 'positional-pillow-sleep-boundary',
        match: /(신생아\s*수면\s*머리\s*모양\s*쿠션|머리\s*모양\s*쿠션\s*수면|positional\s*pillow\s*sleep)/,
        title: '머리 모양 교정 쿠션을 수면에 쓰지 말고 빈 침대·등 재우기를 지키세요',
        lead: '브랜드 순위는 하지 않습니다. 사두는 진료와 상담하세요.',
        points: [
            ['지금', '빈 침대·등'],
            ['주의', '수면 쿠션']
        ],
    ...
    {
        id: 'vitamin-d-timing-feed-boundary',
        match: /((비타민\s*d\s*점적\s*타이밍|비타민\s*디\s*수유\s*전|vitamin\s*d\s*timing\s*feed|비타민d\s*점적\s*언제))/,
        title: '비타민D 투여 시각은 처방·표시를 따르고 빼먹었다고 배량하지 마세요',
        lead: '용량은 여기서 정하지 않습니다.',
        points: [
            ['원칙', '표시·처방'],
            ['금지', '임의 배량']
        ],
        blocks: [
            ['지금 할 일', '복용 시각을 정해 보세요.'],
            ['하지 않을 일', '빼먹었다고 두 배로 주지 마세요.'],
            ['관련', '비타민D 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'imaginary-friend-real-boundary',
        match: /(상상\s*친구\s*진짜라고|상상\s*친구\s*진짜|허구\s*친구\s*믿|imaginary\s*friend\s*real)/,
        title: '상상 친구를 진짜라고 해도 바로 거짓으로 몰지 말고 놀이에 참여하되 안전을 지키세요',
        lead: '급격한 위축·환청 수준 걱정은 상담을 검토하세요.',
        points: [
            ['태도', '수용, 안전'],
            ['금지', '조롱']
        ],
    ...
    {
        id: 'imaginary-friend-seat-boundary',
        match: /(상상\s*친구\s*자리|상상\s*친구\s*자리|허구\s*친구\s*식탁|imaginary\s*friend\s*seat)/,
        title: '상상 친구 자리를 요구해도 안전만 지키면 놀이로 수용할 수 있습니다',
        lead: '급격한 위축이 있으면 상담을 검토하세요.',
        points: [
            ['태도', '수용, 안전'],
            ['금지', '조롱']
        ],
    ...
    {
        id: 'imaginary-friend-meal-boundary',
        match: /(상상\s*친구\s*밥상|상상\s*친구\s*밥상|imaginary\s*friend\s*meal)/,
        title: '상상 친구 밥상 자리는 안전만 지키면 놀이로 수용할 수 있습니다',
        lead: '급격한 위축이 있으면 상담을 검토하세요.',
        points: [
            ['지금', '수용·안전'],
            ['주의', '조롱']
    ...
    {
        id: 'preschool-entry-crying-boundary',
        match: /(유치원\s*입학\s*울음|유치원\s*입학\s*울음|유치원\s*첫\s*날|preschool\s*entry\s*crying)/,
        title: '유치원 입학 울음에는 짧고 일관된 이별과 루틴이 도움이 될 수 있습니다',
        lead: '지속되는 공포·신체 증상은 상담하세요.',
        points: [
            ['이별', '짧게, 같은 인사'],
            ['피하기', '몰래 나가기']
        ],
    ...
    {
        id: 'night-parent-seeking-boundary',
        match: /(밤에\s*부모\s*찾기|밤에\s*부모\s*찾|자다가\s*엄마\s*찾아|night\s*parent\s*seeking)/,
        title: '밤에 부모를 찾는 행동은 분리·수면 발달과 겹칠 수 있어 짧게 안심시키고 침대로 안내하세요',
        lead: '위험 신호가 있으면 진료하세요. 수면제 추천은 하지 않습니다.',
        points: [
            ['대응', '짧게 안심'],
            ['환경', '안전수면']
        ],
        blocks: [
            ['지금 할 일', '짧게 말하고 침대로 안내하세요.'],
            ['하지 않을 일', '긴 놀이를 시작하지 마세요.'],
            ['관련', '분리·수면 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'pickup-clingy-boundary',
        match: /(하원\s*때\s*매달리기|하원\s*때\s*매달리기|하원\s*분리\s*불안|pickup\s*clingy)/,
        title: '하원 때 매달리면 짧게 안심시키고 루틴을 유지하며 지속되면 상담을 검토하세요',
        lead: '갑자기 무섭게 떼어내지 마세요.',
        points: [
            ['대응', '짧게 안심, 루틴'],
            ['상담', '지속 공포']
        ],
        blocks: [
            ['지금 할 일', '하원 인사를 정해 보세요.'],
            ['하지 않을 일', '창피하다고 혼내지 마세요.'],
            ['관련', '분리불안 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가족', 'https://www.healthychildren.org/English/family-life/family-dynamics/communication-discipline/Pages/default.aspx'],
    ...
    {
        id: 'daycare-dropoff-routine-boundary',
        match: /(어린이집\s*등원\s*루틴|어린이집\s*등원\s*루틴|등원\s*인사\s*루틴|daycare\s*dropoff\s*routine)/,
        title: '등원 이별은 짧고 같은 루틴으로 하고 몰래 사라지지 마세요',
        lead: '지속되는 공포·신체 증상은 상담하세요.',
        points: [
            ['이별', '짧게, 같은 인사'],
            ['피하기', '긴 설득, 몰래 퇴장']
    ...
    {
        id: 'dropoff-door-cry-boundary',
        match: /(등원\s*문\s*앞\s*울음|등원\s*문\s*앞\s*울음|dropoff\s*door\s*cry)/,
        title: '등원 문 앞 울음에는 짧고 일관된 인사 후 떠나세요',
        lead: '지속되는 공포는 상담하세요.',
        points: [
            ['지금', '짧게 일관'],
            ['주의', '몰래 퇴장·긴 설득']
    ...
    {
        id: 'night-parent-room-visit-boundary',
        match: /(밤에\s*부모\s*방\s*오기|밤에\s*부모\s*방|night\s*parent\s*room)/,
        title: '밤에 부모 방으로 오면 짧게 안심시키고 아이 침대로 안내하세요',
        lead: '수면제 추천은 하지 않습니다.',
        points: [
            ['지금', '짧게 안심'],
            ['주의', '긴 놀이']
        ],
    ...
    {
        id: 'colic-bicycle-legs-boundary',
        match: /(배앓이\s*자전거\s*다리|배앓이\s*자전거\s*다리|콜릭\s*다리\s*운동|colic\s*bicycle\s*legs)/,
        title: '배앓이 완화에 다리 운동은 시도할 수 있으나 효과는 개인차가 있고 통증·발열이면 진료하세요',
    ...
    {
        id: 'umbilical-odor-care-boundary',
        match: /(배꼽\s*진물\s*냄새|배꼽\s*진물\s*냄새|탯줄\s*냄새\s*감염|umbilical\s*odor)/,
        title: '배꼽 진물·냄새가 나면 임의 민간 요법보다 진료를 검토하세요',
        lead: '소독 방법은 병원 안내를 따르세요.',
        points: [
            ['관찰', '빨강, 열, 냄새'],
            ['금지', '임의 강한 소독 반복']
        ],
    ...
    {
        id: 'low-supply-signs-boundary',
        match: /(젖양\s*부족\s*신호|젖양\s*부족\s*신호|모유\s*부족한지|low\s*supply\s*signs)/,
        title: '젖양 부족 여부는 체중·소변·수유 패턴으로 보고 인터넷 한 가지 신호로 단정하지 마세요',
        lead: '수유 상담·진료를 검토하세요. 용량 단정은 하지 않습니다.',
        points: [
            ['관찰', '체중, 소변, 수유'],
            ['상담', '지속 저하']
        ],
    ...
    {
        id: 'breastmilk-cooler-bag-boundary',
        match: /(모유\s*가방\s*보냉|모유\s*보냉\s*가방|냉동\s*모유\s*이동|breastmilk\s*cooler\s*bag)/,
        title: '모유 이동 시 보냉·해동 안내는 표준·의료진을 따르고 상온 장시간 방치를 피하세요',
        lead: '여기서 시간 숫자를 단정하지 않습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['이동', '보냉, 라벨'],
            ['금지', '해동 후 재냉동']
        ],
    ...
    {
        id: 'cluster-feed-normal-boundary',
        match: /(밤\s*몰아\s*수유\s*정상|밤\s*몰아\s*수유\s*정상|클러스터\s*수유\s*괜찮은지|cluster\s*feed\s*normal)/,
        title: '초저녁·밤 몰아 수유는 흔할 수 있으나 탈수·체중 감소·처짐이면 진료하세요',
        lead: '수유량 숫자를 여기서 단정하지 않습니다.',
        points: [
            ['관찰', '소변, 체중'],
            ['지원', '수유 상담']
        ],
        blocks: [
            ['지금 할 일', '수유·소변을 기록하세요.'],
            ['하지 않을 일', '무조건 분유 보충을 정답으로 보지 마세요.'],
            ['관련', '클러스터 수유 안내를 참고하세요.']
        ],
        links: [
            ['수유 가이드', 'blog/breastfeeding-guide.html'],
    ...
    {
        id: 'toddler-smoothie-sugar-boundary',
        match: /(유아\s*스무디\s*당|유아\s*스무디\s*당|스무디\s*당분\s*아이|toddler\s*smoothie\s*sugar)/,
        title: '스무디·주스형 음료는 당이 많을 수 있어 물·과일 조각을 우선하세요',
        lead: '브랜드 순위는 하지 않습니다. 질식 형태도 보세요.',
        points: [
            ['우선', '물, 통과일'],
            ['제한', '과다 단 음료']
        ],
    ...
    {
        id: 'toddler-soda-boundary',
        match: /(유아\s*탄산\s*음료|유아\s*탄산\s*음료|아이\s*콜라|toddler\s*soda)/,
        title: '어린 아이에게 탄산·가당 청량음료를 주지 않는 편이 좋습니다',
        lead: '물을 우선하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '물, 연령 맞는 우유'],
            ['금지', '탄산 습관']
        ],
    ...
    {
        id: 'juice-before-bed-boundary',
        match: /(유아\s*주스\s*자기\s*전|자기\s*전\s*주스|juice\s*before\s*bed)/,
        title: '자기 전 주스는 치아·수면에 불리할 수 있어 물을 우선하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '물·양치'],
            ['주의', '취침 직전 주스']
    ...
    {
        id: 'inbed-sleeper-use-boundary',
        match: /(인베드\s*슬리퍼\s*사용\s*점검|inbed\s*sleeper\s*use|인베드\s*사용\s*점검)/,
        title: '인베드 슬리퍼·침대 속 아기 공간 제품은 안전수면 기준과 설명서를 엄격히 확인하세요',
        lead: '제품만으로 침대 공유 위험이 없어지지 않을 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '설명서·기준 확인'],
            ['주의', '헐렁한 침구와 혼용']
        ],
        blocks: [
            ['지금 할 일', '연령·체중 한도를 확인하세요.'],
            ['하지 않을 일', '이불·베개를 함께 넣지 마세요.'],
            ['관련', '인베드·안전수면 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
            ['CPSC', 'https://www.cpsc.gov/']
    ...
    {
        id: 'exhausted-bedshare-boundary',
        match: /(피곤할\s*때\s*침대\s*공유|피곤\s*침대\s*공유|exhausted\s*bed\s*share)/,
        title: '극도로 피곤할 때 성인 침대·소파에서 아기와 함께 잠들지 마세요',
        lead: '수유 중 졸리면 아기를 안전 수면 공간에 두세요.',
        points: [
            ['지금', '별도 수면면'],
            ['주의', '소파·침대 위험 공유']
        ...
        blocks: [
            ['지금 할 일', '졸리면 아기를 침대로 옮기세요.'],
            ['하지 않을 일', '소파에서 수유하다 잠들지 마세요.'],
            ['관련', '침대 공유 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'paci-sleep-hygiene-boundary',
        match: /(쪽쪽이\s*재우기\s*위생|쪽쪽이\s*위생|paci\s*hygiene\s*sleep)/,
        title: '재우기 쪽쪽이는 청결을 유지하고 목걸이 끈을 쓰지 마세요',
        lead: '찢어지면 교체하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '청결·교체'],
            ['주의', '목 끈 감김']
        ],
    ...
    {
        id: 'toddler-food-sodium-label-boundary',
        match: /(유아식\s*나트륨\s*표시|유아식\s*나트륨\s*표시|아기\s*과자\s*나트륨|toddler\s*food\s*sodium\s*label)/,
        title: '가공 유아 간식은 나트륨·당 표시를 보고 전체 식단에서 조절하세요',
        lead: '한 제품만으로 단정하지 않습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['확인', '표시, 빈도'],
            ['대안', '담백한 음식']
        ],
    ...
    {
        id: 'toddler-yogurt-sugar-boundary',
        match: /(유아\s*요거트\s*당|유아\s*요거트\s*당|요거트\s*설탕\s*아이|toddler\s*yogurt\s*sugar)/,
        title: '요거트는 당 첨가 표시를 보고 과다한 단 제품을 줄이세요',
        lead: '브랜드 순위는 하지 않습니다. 알레르기는 별도로 보세요.',
        points: [
            ['확인', '성분표, 빈도'],
            ['대안', '무가당·과일 자체']
        ],
    ...
    {
        id: 'toddler-snack-added-sugar-boundary',
        match: /(유아\s*간식\s*설탕|유아\s*간식\s*설탕|toddler\s*snack\s*added\s*sugar)/,
        title: '유아 간식의 첨가당을 줄이고 과일·담백한 대안을 검토하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '표시 확인·빈도 조절'],
            ['주의', '단 간식 상시']
    ...
    {
        id: 'hiccup-during-feed-boundary',
        match: /(신생아\s*딸꾹질\s*수유|수유\s*중\s*딸꾹질|딸꾹질\s*나면\s*수유|hiccup\s*during\s*feed)/,
        title: '수유 중 딸꾹질은 흔할 수 있으나 호흡·수유 저하가 있으면 진료하세요',
        lead: '민간 요법으로 억지로 멈추려 하지 마세요.',
        points: [
            ['관찰', '수유, 호흡'],
            ['피하기', '강한 자극']
        ],
        blocks: [
            ['지금 할 일', '잠시 쉬었다 수유를 이어보세요.'],
            ['하지 않을 일', '세게 놀라게 하지 마세요.'],
            ['관련', '딸꾹질 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'rsv-breathing-watch-boundary',
        match: /(rsv\s*숨소리\s*관찰|rsv\s*breathing\s*watch|호흡기\s*세포융합\s*호흡\s*관찰)/,
        title: 'RSV·호흡기 감염 의심 시 숨가쁨·수유 저하·처짐을 보고 진료 기준을 확인하세요',
        lead: '진단은 의료진이 합니다. 약 용량 단정은 하지 않습니다.',
        points: [
            ['관찰', '호흡, 수유, 처짐'],
            ['응급', '무호흡, 청색']
        ],
    ...
    {
        id: 'retractions-breathing-boundary',
        match: /(호흡\s*함몰|호흡\s*함몰|retractions\s*breathing)/,
        title: '갈비·목 함몰이 보이면 호흡 곤란 신호일 수 있어 즉시 진료를 검토하세요',
        lead: '청색·무호흡은 응급입니다.',
        points: [
            ['지금', '즉시 진료'],
            ['주의', '기다리기만']
    ...
    {
        id: 'sleep-training-age-boundary',
        match: /(수면\s*교육\s*개월|수면\s*교육\s*몇\s*개월|슬립트레이닝\s*시작\s*월령|sleep\s*training\s*age)/,
        title: '수면 교육 시작 시점은 월령·체중·의료 상황을 보고 단정하지 마세요',
        lead: '신생아에게 긴 울림 방치는 피하세요. 앱 순위는 하지 않습니다.',
        points: [
            ['전제', '성장, 건강'],
            ['금지', '위험 수면 환경']
        ],
    ...
    {
        id: 'sleep-training-neighbor-noise-boundary',
        match: /(수면\s*교육\s*이웃\s*소음|수면\s*교육\s*이웃\s*소음|울음\s*수면\s*교육\s*민원|sleep\s*training\s*neighbor)/,
        title: '수면 교육 중 울음이 걱정되면 방법·월령을 재검토하고 안전수면을 지키세요',
        lead: '앱 순위는 하지 않습니다. 신생아 긴 방치는 피하세요.',
        points: [
            ['전제', '건강, 월령'],
            ['원칙', '안전수면']
        ],
    ...
    {
        id: 'sleep-training-guilt-boundary',
        match: /(수면\s*교육\s*죄책감|수면\s*교육\s*죄책감|sleep\s*training\s*guilt)/,
        title: '수면 교육 방법 선택은 가족·월령·건강을 보고 죄책감만으로 결정하지 마세요',
        lead: '신생아 긴 방치는 피하세요. 앱 순위는 하지 않습니다.',
        points: [
            ['지금', '건강·안전수면'],
            ['주의', '앱 맹신']
        ],
    ...
    {
        id: 'pinkeye-glasses-clean-boundary',
        match: /(눈병\s*안경\s*닦기|눈병\s*안경\s*닦|결막염\s*안경|pinkeye\s*glasses\s*clean)/,
        title: '결막염이 의심되면 안경·수건을 구분하고 손을 자주 씻기세요',
        lead: '진단·약은 의료진을 따르세요. 사진 진단은 하지 않습니다.',
        points: [
            ['위생', '수건 분리'],
            ['금지', '눈 비비기']
    ...
    {
        id: 'dehydration-no-tears-boundary',
        match: /(탈수\s*눈물\s*없음|탈수\s*눈물\s*없음|울어도\s*눈물\s*안|dehydration\s*no\s*tears)/,
        title: '울어도 눈물이 적고 소변이 줄면 탈수를 의심하고 진료를 검토하세요',
        lead: 'ORS·수분은 안내·의료진을 따르세요. 용량 단정은 하지 않습니다.',
        points: [
            ['신호', '소변, 처짐, 입마름'],
            ['행동', '수분, 진료']
        ],
    ...
    {
        id: 'dehydration-fewer-diapers-boundary',
        match: /(탈수\s*기저귀\s*감소|탈수\s*기저귀\s*감소|dehydration\s*fewer\s*diapers)/,
        title: '젖은 기저귀가 줄고 처지면 탈수를 의심하고 진료를 검토하세요',
        lead: 'ORS·수분은 안내·의료진을 따르세요.',
        points: [
            ['지금', '기저귀·처짐'],
            ['주의', '수분 거부 방치']
        ],
    ...
    {
        id: 'croup-night-worsen-boundary',
        match: /(크룹\s*밤\s*증상|크룹\s*밤\s*심해|컹컹\s*기침\s*밤|croup\s*night\s*worsen)/,
        title: '크룹처럼 컹컹 기침이 밤에 심해지면 호흡을 보고 함몰·청색이면 응급 진료하세요',
        lead: '약 용량은 의료진을 따르세요. 사진 진단은 하지 않습니다.',
        points: [
            ['관찰', '호흡, 함몰'],
            ['응급', '힘겨운 호흡, 청색']
        ],
        blocks: [
            ['지금 할 일', '차분한 환경에서 지켜보세요.'],
    ...
    {
        id: 'croup-humid-air-boundary',
        match: /(컹컹\s*기침\s*가습|컹컹\s*기침\s*가습|croup\s*humid)/,
        title: '컹컹 기침 시 차분한 환경에서 관찰하고 호흡 곤란이면 응급 진료하세요',
        lead: '약 용량은 의료진을 따르세요. 사진 진단은 하지 않습니다.',
        points: [
            ['지금', '호흡 관찰'],
            ['주의', '연기 쐬기 민간 요법']
    ...
    {
        id: 'ear-infection-fly-delay-boundary',
        match: /(중이염\s*비행\s*금지|중이염\s*비행\s*미루|귀\s*아플\s*때\s*비행기|ear\s*infection\s*fly\s*delay)/,
        title: '중이염·귀 통증이 있을 때 비행은 의료진과 상의하고 이착륙 삼킴을 도우세요',
        lead: '약 용량은 단정하지 않습니다.',
        points: [
            ['상담', '진료 상태'],
            ['도움', '수유, 물']
        ],
    ...
    {
        id: 'ear-infection-swim-boundary',
        match: /(중이염\s*수영|중이염\s*수영|귀\s*아플\s*때\s*수영|ear\s*infection\s*swim)/,
        title: '중이염·귀 통증 때 수영은 의료진 안내를 따르고 통증이 심하면 미루세요',
        lead: '약 용량은 단정하지 않습니다.',
        points: [
            ['상담', '진료 상태'],
            ['주의', '통증, 발열']
    ...
    {
        id: 'ear-pain-night-boundary',
        match: /(귀\s*통증\s*밤|귀\s*통증\s*밤|ear\s*pain\s*night)/,
        title: '밤에 귀 통증이 심하면 수분·자세를 돕고 고열·처짐이면 진료를 검토하세요',
        lead: '약 용량은 표시·진료를 따르세요. 여기서 ml를 정하지 않습니다.',
        points: [
            ['지금', '관찰·진료'],
            ['주의', '면봉 파기']
        ],
    ...
    {
        id: 'blw-highchair-belt-boundary',
        match: /(blw\s*의자\s*벨트\s*채우|blw\s*high\s*chair\s*belt|아기주도\s*하이체어\s*벨트)/,
        title: 'BLW 때도 하이체어 벨트를 채우고 앉은 자세에서만 먹이세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '벨트·앉기·감독'],
            ['주의', '달리며 먹이기']
        ...
        blocks: [
            ['지금 할 일', '벨트를 채우세요.'],
            ['하지 않을 일', '서 있는 채 먹이지 마세요.'],
            ['관련', 'BLW·하이체어 안내를 참고하세요.']
        ],
        links: [
            ['AAP 질식', 'https://www.healthychildren.org/English/health-issues/injuries-emergencies/Pages/Choking-Prevention.aspx'],
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx']
    ...
    {
        id: 'iron-rich-solid-worry-boundary',
        match: /(철분\s*이유식\s*부족|철분\s*이유식\s*부족|철분\s*음식\s*뭐|iron\s*rich\s*solid\s*worry)/,
        title: '철분 섭취 걱정은 식단 다양성과 성장·검사를 의료진과 보세요',
        lead: '특정 식품 광고를 정답으로 보지 마세요. 보충제 용량은 의료진을 따르세요.',
        points: [
            ['식단', '다양한 철분 식품'],
            ['상담', '창백, 성장 저하']
        ],
    ...
    {
        id: 'roomshare-noise-boundary',
        match: /(신생아\s*룸셰어\s*소음|룸셰어\s*소음|room\s*share\s*noise)/,
        title: '룸셰어 중 소음은 백색 소음 과다보다 안전수면·통풍을 우선하세요',
        lead: '볼륨·거리를 조절하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '같은 방·별도 수면면'],
            ['주의', '최대 볼륨 근접']
        ],
    ...
    {
        id: 'handwash-song-timer-boundary',
        match: /(손\s*씻기\s*노래|손\s*씻기\s*노래|손\s*씻기\s*20초|handwash\s*song\s*timer)/,
        title: '손 씻기는 비누로 구석구석, 충분한 시간 문지르는 습관을 들이세요',
        lead: '노래는 보조일 뿐입니다. 소독제 브랜드 순위는 하지 않습니다.',
        points: [
            ['방법', '비누, 문지르기'],
            ['때', '식사 전, 화장실 후']
        ],
    ...
    {
        id: 'after-outing-handwash-boundary',
        match: /(외출\s*후\s*손\s*씻기|외출\s*후\s*손\s*씻기|집\s*도착\s*손\s*씻|after\s*outing\s*handwash)/,
        title: '외출 후·식사 전 손 씻기를 루틴으로 하고 눈에 띄게 더러우면 비누를 우선하세요',
        lead: '소독제 브랜드 순위는 하지 않습니다.',
        points: [
            ['때', '외출 후, 식사 전'],
            ['방법', '비누, 문지르기']
        ],
    ...
    {
        id: 'after-nose-blow-handwash-boundary',
        match: /(코\s*풀고\s*손\s*씻기|코\s*풀고\s*손\s*씻|after\s*nose\s*blow\s*handwash)/,
        title: '코를 풀거나 기침한 뒤 손을 씻기세요',
        lead: '감염 전파를 줄이는 데 도움이 됩니다.',
        points: [
            ['지금', '손 씻기'],
            ['주의', '손으로 눈 비비기']
        ],
    ...
    {
        id: 'nail-ingrown-care-boundary',
        match: /(발톱\s*살\s*파임|발톱\s*살\s*파|내성발톱\s*아이|ingrown\s*toenail\s*child)/,
        title: '발톱이 살을 파고들면 억지로 깊게 깎지 말고 통증·염증이 있으면 진료하세요',
        lead: '민간 시술은 피하세요.',
        points: [
            ['관리', '바르게 깎기'],
            ['진료', '붉음, 고름, 통증']
        ...
        blocks: [
            ['지금 할 일', '모서리를 둥글게 너무 깊게 파지 마세요.'],
            ['하지 않을 일', '염증을 방치하지 마세요.'],
            ['관련', '손발톱 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'newborn-bath-frequency-boundary',
        match: /(신생아\s*목욕\s*횟수|신생아\s*목욕\s*횟수|신생아\s*매일\s*목욕|newborn\s*bath\s*frequency)/,
        title: '신생아 목욕은 매일 필수는 아닐 수 있으며, 피부 건조·탯줄 안내를 함께 보세요',
        lead: '병원 안내를 우선하세요. 제품 순위는 하지 않습니다.',
        points: [
            ['원칙', '청결, 건조 균형'],
            ['주의', '과열, 미끄럼']
        ],
    ...
    {
        id: 'swim-without-hat-sun-boundary',
        match: /(모자\s*없이\s*물놀이|모자\s*없이\s*물놀이|수영\s*자외선\s*모자|swim\s*without\s*hat\s*sun)/,
        title: '물놀이 때도 그늘·옷·모자·선크림을 함께 쓰세요',
        lead: '6개월 미만은 의료진 권고를 우선하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['기본', '그늘, 옷, 모자'],
            ['도포', '물 후 재도포']
    ...
    {
        id: 'sports-day-no-shade-boundary',
        match: /(그늘\s*없이\s*운동회|그늘\s*없이\s*운동회|sports\s*day\s*no\s*shade)/,
        title: '운동회에 그늘·물·모자를 챙기고 한낮 직사광선을 줄이세요',
        lead: '선크림 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '그늘·물·모자'],
            ['주의', '한낮 장시간']
        ],
    ...
    {
        id: 'used-carseat-gift-boundary',
        match: /(카시트\s*중고\s*선물\s*받을\s*때)/,
        title: '중고 카시트 선물은 사고 이력·리콜·만료를 확인하고 불확실하면 받지 마세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '이력·리콜·만료'],
            ['주의', '불명 이력 사용']
    ...
    {
        id: 'booster-shoulder-belt-fit-boundary',
        match: /(부스터\s*어깨\s*벨트\s*핏\s*확인)/,
        title: '부스터 어깨 벨트가 목·얼굴을 스치면 핏이 잘못된 것이니 조절하세요',
        lead: '무릎 벨트도 골반에 맞게 보세요.',
        points: [
            ['지금', '어깨·골반 핏'],
            ['주의', '목에 걸리는 벨트']
        ],
    ...
    {
        id: 'booster-lap-belt-belly-boundary',
        match: /(부스터\s*벨\s*위치\s*배|부스터\s*무릎\s*벨트\s*배|벨트\s*배\s*위|booster\s*lap\s*belt\s*belly)/,
        title: '부스터 무릎 벨트가 배 위로 올라가면 핏이 잘못된 것이니 위치를 바로잡으세요',
        lead: '어깨 벨트도 목에 걸리지 않게 보세요.',
        points: [
            ['핏', '골반, 어깨'],
            ['금지', '배 위 벨트']
        ],
        blocks: [
            ['지금 할 일', '벨트를 골반에 맞게 하세요.'],
            ['하지 않을 일', '안 맞으면 전환을 미루세요.'],
            ['관련', '부스터 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'short-trip-no-carseat-boundary',
        match: /(카시트\s*없이\s*단거리|카시트\s*없이\s*단거리|잠깐\s*카시트\s*없이|short\s*trip\s*no\s*car\s*seat)/,
        title: '단거리라도 카시트 없이 이동하지 않는 편이 안전합니다',
        lead: '법률·상황은 지역마다 다를 수 있으나 안전상 카시트가 최선입니다.',
        points: [
            ['원칙', '카시트 사용'],
            ['금지', '무릎 탑승']
        ],
        blocks: [
            ['지금 할 일', '미리 카시트를 설치하세요.'],
            ['하지 않을 일', '안고 타지 마세요.'],
            ['관련', '카시트 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'airport-pickup-carseat-boundary',
        match: /(공항\s*픽업\s*카시트|공항\s*픽업\s*카시트|공항\s*택시\s*카시트|airport\s*pickup\s*car\s*seat)/,
        title: '공항 픽업 때도 가능하면 카시트를 쓰고 없는 이동은 최소화하세요',
        lead: '법률·상황은 지역마다 다를 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['최선', '카시트'],
            ['차선', '뒷좌석, 짧은 이동']
        ],
        blocks: [
            ['지금 할 일', '미리 카시트 옵션을 확인하세요.'],
            ['하지 않을 일', '앞좌석에 아이를 태우지 마세요.'],
            ['관련', '카시트 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'rear-facing-legs-bent-ok-boundary',
        match: /(후향\s*다리\s*불편|후향\s*다리\s*불편|후향\s*무릎\s*굽|rear\s*facing\s*legs\s*bent)/,
        title: '후향 카시트에서 다리가 굽는 것만으로 전향할 필요는 없을 수 있습니다',
        lead: '키·체중 한도와 안내를 우선하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '한도 내 후향 유지'],
            ['전환', '한도·라벨']
        ],
    ...
    {
        id: 'rear-facing-mirror-boundary',
        match: /(후향\s*카시트\s*거울|후향\s*카시트\s*거울|아기\s*좌석\s*미러|rear\s*facing\s*mirror)/,
        title: '후향 확인 거울은 시야를 가리지 않게 붙이고 운전에 방해되면 제거하세요',
        lead: '거울 브랜드 순위는 하지 않습니다. 안전 설치가 우선입니다.',
        points: [
            ['설치', '시야, 고정'],
            ['금지', '느슨한 부착']
        ],
        blocks: [
            ['지금 할 일', '떨어지지 않게 고정하세요.'],
            ['하지 않을 일', '앞 시야를 가리지 마세요.'],
            ['관련', '카시트 안내를 참고하세요.']
        ],
        links: [
            ['AAP 카시트', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Car-Safety-Seats-Information-for-Families.aspx'],
    ...
    {
        id: 'rear-facing-max-weight-boundary',
        match: /(후향\s*최대\s*체중|후향\s*최대\s*체중|rear\s*facing\s*max\s*weight)/,
        title: '후향 유지 시 시트 최대 체중·키 라벨을 확인하고 한도 전에 바꾸지 마세요',
        lead: '연령만으로 전향하지 마세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '라벨 한도'],
            ['주의', '돌이면 무조건 전향']
        ],
    ...
    {
        id: 'carseat-harness-twist-boundary',
        match: /(카시트\s*벨트\s*꼬임|카시트\s*벨트\s*꼬임|하네스\s*꼬임|car\s*seat\s*harness\s*twist)/,
        title: '카시트 어깨 벨트가 꼬이지 않게 펴고 가슴 클립 위치를 확인하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['점검', '꼬임, 밀착'],
            ['금지', '두꺼운 옷 끼움']
    ...
    {
        id: 'carseat-video-only-install-boundary',
        match: /(카시트\s*설치\s*동영상만|카시트\s*설치\s*동영상만|유튜브\s*카시트\s*설치|carseat\s*video\s*only\s*install)/,
        title: '카시트 설치는 설명서와 흔들림 확인이 우선이고 동영상만 맹신하지 마세요',
        lead: '검사 이벤트를 활용할 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['점검', '설명서, 흔들림'],
            ['금지', '대충 설치']
        ],
        blocks: [
            ['지금 할 일', '좌우 흔들림을 확인하세요.'],
            ['하지 않을 일', '두꺼운 패딩을 벨트 아래 끼우지 마세요.'],
            ['관련', '카시트 안내를 참고하세요.']
        ],
        links: [
            ['AAP 카시트', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Car-Safety-Seats-Information-for-Families.aspx'],
    ...
    {
        id: 'carseat-chest-clip-position-boundary',
        match: /(카시트\s*가슴\s*클립\s*위치|카시트\s*가슴\s*클립\s*위치|하네스\s*클립\s*높이|car\s*seat\s*chest\s*clip)/,
        title: '카시트 가슴 클립은 겨드랑이 높이 안내를 확인하고 꼬임 없이 조이세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['위치', '겨드랑이 높이'],
            ['금지', '배 아래 클립']
    ...
    {
        id: 'carseat-inspection-event-boundary',
        match: /(카시트\s*설치\s*검사|카시트\s*설치\s*검사|car\s*seat\s*inspection)/,
        title: '카시트 설치 검사 이벤트·설명서로 설치를 확인하고 흔들림을 점검하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '설명서·검사'],
            ['주의', '대충 설치']
    ...
    {
        id: 'playground-name-tag-boundary',
        match: /(놀이터\s*마스크\s*분실\s*예방)/,
        title: '놀이터·축제에서는 이름·연락처와 만날 장소를 정하세요',
        lead: '개인정보 노출은 최소로 하세요.',
        points: [
            ['준비', '만날 장소, 연락'],
            ['감독', '시야 내']
        ],
    ...
    {
        id: 'wet-playground-equipment-boundary',
        match: /(놀이터\s*젖은\s*기구|놀이터\s*젖은\s*기구|비\s*온\s*뒤\s*미끄럼틀|wet\s*playground\s*equipment)/,
        title: '비 온 뒤 젖은 놀이 기구는 미끄럼·화상을 확인하고 위험하면 이용을 미루세요',
        lead: '금속은 뜨거울 수도 있습니다.',
        points: [
            ['확인', '미끄럼, 온도'],
            ['금지', '파손 기구']
        ],
        blocks: [
            ['지금 할 일', '손으로 온도를 느껴 보세요.'],
            ['하지 않을 일', '뛰며 밀지 마세요.'],
            ['관련', '놀이터 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'playground-damage-report-boundary',
        match: /(놀이터\s*파손\s*신고|놀이터\s*파손\s*신고|playground\s*damage\s*report)/,
        title: '놀이터 기구가 파손·녹슬면 이용을 중단하고 관리자에게 알리세요',
        lead: '시설 추천은 하지 않습니다.',
        points: [
            ['지금', '중단·신고'],
            ['주의', '파손 기구 이용']
    ...
    {
        id: 'stair-gate-top-bottom-boundary',
        match: /(아기\s*문\s*계단\s*위아래|계단\s*문\s*위아래|안전문\s*계단\s*위|stair\s*gate\s*top\s*bottom)/,
        title: '계단 위·아래에 맞는 안전문을 설치하고 하드웨어 장착 안내를 따르세요',
        lead: '압착식만으로 계단 위는 위험할 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['설치', '위치별 적합 방식'],
            ['점검', '잠금, 흔들림']
        ],
    ...
    {
        id: 'stair-gate-left-open-boundary',
        match: /(안전문\s*열린\s*채|안전문\s*열린\s*채|계단\s*문\s*안\s*닫|stair\s*gate\s*left\s*open)/,
        title: '계단 안전문은 통과 후 바로 닫고 잠금이 되는지 확인하세요',
        lead: '열린 채 두면 소용이 없습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['습관', '닫기, 잠금'],
            ['점검', '흔들림']
        ],
    ...
    {
        id: 'outlet-cover-remove-boundary',
        match: /(콘센트\s*커버\s*떼기|콘센트\s*커버\s*떼|안전\s*커버\s*분해|outlet\s*cover\s*remove\s*child)/,
        title: '콘센트 커버를 떼어 입에 넣지 않게 하고 파손되면 교체하세요',
        lead: '감전·질식 위험이 있습니다.',
        points: [
            ['점검', '헐거움, 파손'],
            ['금지', '작은 커버 삼킴']
        ...
        blocks: [
            ['지금 할 일', '맞는 크기의 보호를 쓰세요.'],
            ['하지 않을 일', '떨어진 커버를 바닥에 두지 마세요.'],
            ['관련', '콘센트 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'chewed-cord-danger-boundary',
        match: /(전선\s*물린\s*자국|전선\s*물린\s*자국|코드\s*이빨\s*자국|chewed\s*cord\s*danger)/,
        title: '전선에 이빨 자국이 있으면 즉시 사용을 중단하고 교체하세요',
        lead: '감전·화재 위험이 있습니다.',
        points: [
            ['즉시', '전원 차단, 교체'],
            ['금지', '테이프로 임시 사용']
    ...
    {
        id: 'outlet-overload-boundary',
        match: /(콘센트\s*멀티\s*과부하|콘센트\s*과부하|outlet\s*overload)/,
        title: '한 콘센트·멀티탭에 과다 연결하지 말고 정격을 지키세요',
        lead: '화재·감전 위험이 있습니다.',
        points: [
            ['지금', '정격·먼지 관리'],
            ['주의', '문어발 과다']
    ...
    {
        id: 'door-gap-finger-guard-boundary',
        match: /(방문\s*손가락\s*문틈\s*가드)/,
        title: '문틈 손가락 끼임을 막기 위해 천천히 닫고 가드를 검토하세요',
        lead: '제품 순위는 하지 않습니다.',
        points: [
            ['지금', '천천히·가드'],
            ['주의', '세게 닫기']
        ...
        blocks: [
            ['지금 할 일', '닫기 전 손을 확인하세요.'],
            ['하지 않을 일', '바람으로 쾅 닫히게 두지 마세요.'],
            ['관련', '문 끼임 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'door-slam-finger-boundary',
        match: /(방문\s*손가락\s*문|방문\s*손가락\s*끼|문\s*세게\s*닫\s*손|door\s*slam\s*finger)/,
        title: '문이 세게 닫히지 않게 스토퍼를 검토하고 손가락 위치를 보세요',
        lead: '제품 순위는 하지 않습니다.',
        points: [
            ['예방', '스토퍼, 천천히'],
            ['감독', '문틈']
    ...
    {
        id: 'door-closer-soft-boundary',
        match: /(방문\s*닫힘\s*방지|방문\s*천천히\s*닫|도어\s*클로저\s*아이|door\s*soft\s*close\s*child)/,
        title: '문이 쾅 닫히지 않게 하고 손가락 끼임을 막으세요',
        lead: '스토퍼·가드를 검토하세요. 제품 순위는 하지 않습니다.',
        points: [
            ['예방', '천천히 닫기'],
            ['감독', '문틈']
        ],
    ...
    {
        id: 'beach-flag-rip-boundary',
        match: /(해변\s*이안류\s*깃발)/,
        title: '해변 깃발·안내를 확인하고 금지 구역·이안류 경고를 지키세요',
        lead: '구명조끼와 성인 감독이 중요합니다.',
        points: [
            ['확인', '깃발, 구조대'],
            ['금지', '금지 구역 입수']
        ],
        blocks: [
            ['지금 할 일', '안전 구역에서만 놀으세요.'],
    ...
    {
        id: 'beach-sand-hole-collapse-boundary',
        match: /(해변\s*모래\s*파기|해변\s*모래\s*구덩이|모래\s*구멍\s*무너|beach\s*sand\s*hole\s*collapse)/,
        title: '해변에서 깊은 구덩이를 파지 말고 무너짐·질식을 조심하세요',
        lead: '성인 감독이 필요합니다.',
        points: [
            ['금지', '깊은 굴, 터널'],
            ['감독', '파도, 이안류']
    ...
    {
        id: 'beach-wave-watch-boundary',
        match: /(해변\s*파도\s*주의|해변\s*파도\s*주의|beach\s*wave\s*watch)/,
        title: '해변 파도가 셀 때는 얕은 구역·성인 감독을 지키고 깃발을 확인하세요',
        lead: '이안류 안내를 따르세요.',
        points: [
            ['지금', '깃발·감독'],
            ['주의', '깊은 입수']
    ...
    {
        id: 'sunburn-after-swim-boundary',
        match: /(물놀이\s*후\s*화상|물놀이\s*후\s*화상|수영\s*후\s*빨개|sunburn\s*after\s*swim)/,
        title: '물놀이 후 피부가 붉으면 시원하게 하고 물집을 터뜨리지 말고 심하면 진료하세요',
        lead: '해열제·연고 용량은 의료진·표시를 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['관리', '시원, 수분'],
            ['금지', '물집 터뜨리기']
        ],
    ...
    {
        id: 'white-noise-app-claim-boundary',
        match: /(백색소음\s*앱\s*광고|백색소음\s*앱\s*광고|화이트노이즈\s*만능|white\s*noise\s*app\s*claim)/,
        title: '백색 소음 앱 광고를 만능으로 보지 말고 볼륨·거리를 조절하세요',
        lead: '브랜드·앱 순위는 하지 않습니다.',
        points: [
            ['조절', '낮은 볼륨, 거리'],
            ['피하기', '최대 음량 근접']
        ],
    ...
    {
        id: 'lullaby-volume-boundary',
        match: /(자장가\s*볼륨|자장가\s*볼륨|lullaby\s*volume)/,
        title: '자장가·수면 소리 볼륨을 대화 가능 수준 이하로 조절하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '낮은 볼륨·거리'],
            ['주의', '최대 음량']
    ...
    {
        id: 'white-noise-speaker-place-boundary',
        match: /(백색소음\s*스피커\s*위치|백색소음\s*스피커\s*위치|white\s*noise\s*speaker\s*place)/,
        title: '백색 소음 스피커는 머리에서 떨어뜨리고 볼륨을 낮게 유지하세요',
        lead: '최대 볼륨 근접을 피하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '거리·낮은 볼륨'],
            ['주의', '머리 옆 최대 음량']
        ],
    ...
    {
        id: 'cyberbullying-child-boundary',
        match: /(온라인\s*괴롭힘|온라인\s*괴롭힘|사이버\s*불링\s*아이|cyberbullying\s*child)/,
        title: '온라인 괴롭힘이 의심되면 증거를 저장하고 학교·상담·필요 시 신고 경로를 연결하세요',
        lead: '무시하라고만 하지 마세요.',
        points: [
            ['즉시', '증거 보관, 차단'],
            ['연결', '학교, 상담']
    ...
    {
        id: 'school-violence-report-boundary',
        match: /(학교\s*폭력\s*신고|학교\s*폭력\s*신고|따돌림\s*신고\s*학교|school\s*violence\s*report)/,
        title: '학교 폭력·따돌림이 의심되면 증거를 남기고 학교·상담·필요 시 신고 경로를 연결하세요',
        lead: '무시하라고만 하지 마세요.',
        points: [
            ['즉시', '안전, 기록'],
            ['연결', '학교, 상담']
    ...
    {
        id: 'peer-exclusion-boundary',
        match: /(친구에게\s*따돌림|친구\s*따돌림|peer\s*exclusion)/,
        title: '따돌림·배제가 의심되면 아이 말을 듣고 학교·상담과 연결하세요',
        lead: '무시하라고만 하지 마세요.',
        points: [
            ['지금', '경청·연결'],
            ['주의', '아이 탓']
    ...
    {
        id: 'new-baby-gift-sibling-boundary',
        match: /(새\s*아기\s*선물\s*형|새\s*아기\s*선물\s*형|동생\s*태어나\s*선물|new\s*baby\s*gift\s*sibling)/,
        title: '새 아기 때 첫째에게 관심·개별 시간을 주고 선물은 선택일 뿐입니다',
        lead: '선물 브랜드 순위는 하지 않습니다.',
        points: [
            ['우선', '개별 시간, 설명'],
            ['금지', '폭력 방치']
        ],
        blocks: [
            ['지금 할 일', '하루 짧게라도 첫째만의 시간을 주세요.'],
            ['하지 않을 일', '동생 탓으로만 혼내지 마세요.'],
            ['관련', '형제 질투 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가족', 'https://www.healthychildren.org/English/family-life/family-dynamics/communication-discipline/Pages/default.aspx'],
    ...
    {
        id: 'rough-touch-newborn-sibling-boundary',
        match: /(동생\s*만지기\s*거칠게|동생\s*거칠게\s*만지|형\s*아기\s*때리|rough\s*touch\s*newborn\s*sibling)/,
        title: '첫째가 동생을 거칠게 다루면 즉시 막고 부드러운 만지기를 가르치세요',
        lead: '단독 방치를 하지 마세요.',
        points: [
            ['즉시', '막기, 감독'],
            ['교육', '부드러운 손']
    ...
    {
        id: 'firstborn-regression-boundary',
        match: /(첫째\s*퇴행|첫째\s*퇴행|firstborn\s*regression)/,
        title: '동생 생후 첫째 퇴행은 흔할 수 있어 개별 시간과 안정을 주세요',
        lead: '때리기는 막으세요.',
        points: [
            ['지금', '개별 시간·설명'],
            ['주의', '폭력 방치']
    ...
    {
        id: 'thumb-sucking-teeth-boundary',
        match: /(손가락\s*빨기\s*치아|손가락\s*빨기\s*치아|엄지\s*빨\s*이빨|thumb\s*sucking\s*teeth)/,
        title: '손가락 빨기가 치아·교합에 영향이 걱정되면 치과·의료진과 상담하세요',
        lead: '어린 시기에는 흔할 수 있습니다. 수치심 주기는 피하세요.',
        points: [
            ['관찰', '연령, 치아 변화'],
            ['태도', '비난 금지']
        ],
    ...
    {
        id: 'infant-cpr-refresh-boundary',
        match: /(영아\s*cpr\s*재교육|영아\s*심폐소생\s*갱신|infant\s*cpr\s*refresh|영아\s*cpr\s*주기\s*재)/,
        title: '영아 심폐소생 기술은 재교육으로 유지하고 응급 시 119를 우선하세요',
        lead: '유튜브만으로 충분하다고 보지 마세요.',
        points: [
            ['준비', '공인 재교육'],
            ['응급', '119']
    ...
    {
        id: 'infant-emergency-class-boundary',
        match: /(영아\s*응급\s*교육|영아\s*응급\s*교육|infant\s*emergency\s*class)/,
        title: '영아 심폐소생·질식 응급 교육을 미리 받아 두세요',
        lead: '유튜브만으로 충분하다고 보지 마세요. 응급이면 119를 우선하세요.',
        points: [
            ['지금', '공인 교육'],
            ['주의', '영상만 의존']
        ],
    ...
    {
        id: 'campfire-distance-child-boundary',
        match: /(캠프파이어\s*거리|캠프파이어\s*거리\s*아이|모닥불\s*가까이\s*아이|campfire\s*distance\s*child)/,
        title: '캠프파이어·그릴 주변에 선을 정하고 아이가 뛰어 들어가지 않게 하세요',
        lead: '불씨·연기·일산화탄소를 조심하세요.',
        points: [
            ['거리', '성인 사이, 경계선'],
            ['금지', '뛰어다님, 불씨 만지기']
        ],
        blocks: [
            ['지금 할 일', '불을 완전히 끄고 확인하세요.'],
            ['하지 않을 일', '불 옆에 두지 마세요.'],
            ['관련', '캠프파이어 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'campfire-extinguish-check-boundary',
        match: /(모닥불\s*끄기\s*확인|모닥불\s*끄기\s*확인|campfire\s*extinguish)/,
        title: '캠프파이어는 물로 끄고 식었는지 확인한 뒤 자리를 떠나세요',
        lead: '불씨·연기를 조심하세요.',
        points: [
            ['지금', '완전 소화'],
            ['주의', '불씨 방치']
    ...
    {
        id: 'microwave-popcorn-steam-boundary',
        match: /(전자레인지\s*팝콘\s*김|전자레인지\s*팝콘\s*김|팝콘\s*봉\s*화상|microwave\s*popcorn\s*steam)/,
        title: '전자레인지 팝콘·즉석식품은 김을 얼굴 반대쪽으로 열고 아이 손에 주지 마세요',
        lead: '스팀 화상이 납니다.',
        points: [
            ['방법', '멀리 개봉, 식히기'],
            ['금지', '아이 앞에서 급개봉']
        ...
        blocks: [
            ['지금 할 일', '식힌 뒤 주세요.'],
            ['하지 않을 일', '바로 입에 대지 마세요.'],
            ['관련', '전자레인지 화상 안내를 참고하세요.']
        ],
        links: [
            ['CDC 화상', 'https://www.cdc.gov/burn-prevention/'],
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx']
    ...
    {
        id: 'hot-soup-near-child-boundary',
        match: /(뜨거운\s*국\s*아이\s*옆|뜨거운\s*국\s*아이\s*옆|국그릇\s*테이블\s*가장자리|hot\s*soup\s*near\s*child)/,
        title: '뜨거운 국·컵을 테이블 가장자리·아이 옆에 두지 마세요',
        lead: '당겨 화상 사고가 흔합니다.',
        points: [
            ['배치', '안쪽, 중심'],
            ['감독', '당김']
        ...
        blocks: [
            ['지금 할 일', '손잡이를 안쪽으로 두세요.'],
            ['하지 않을 일', '아이 무릎에 뜨거운 것을 두지 마세요.'],
            ['관련', '화상 안내를 참고하세요.']
        ],
        links: [
            ['CDC 화상', 'https://www.cdc.gov/burn-prevention/'],
    ...
    {
        id: 'microwave-bottle-reheat-boundary',
        match: /(전자레인지\s*우유\s*병|전자레인지\s*우유\s*병|분유\s*전자렌지\s*데우|microwave\s*bottle\s*reheat)/,
        title: '분유·모유를 전자레인지로 데우지 않는 편이 안전하고 불균일 가열을 피하세요',
        lead: '중탕·표시 방법을 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['방법', '고른 온도'],
            ['금지', '전자레인지 직가열(권장 아님)']
        ],
    ...
    {
        id: 'aquarium-heater-burn-boundary',
        match: /((어항\s*히터\s*화상|수조\s*히터\s*아이|aquarium\s*heater\s*burn))/,
        title: '어항 히터·전열 기구는 아이 손이 닿지 않게 하고 전복을 막으세요',
        lead: '감전·화상 위험이 있습니다.',
        points: [
            ['배치', '고정, 코드'],
            ['금지', '만지기']
    ...
    {
        id: 'hot-coffee-holding-baby-boundary',
        match: /(뜨거운\s*커피\s*들고\s*아이|뜨거운\s*커피\s*안고|hot\s*coffee\s*holding\s*baby)/,
        title: '아기를 안은 채 뜨거운 커피를 들지 마세요',
        lead: '화상 사고가 흔합니다.',
        points: [
            ['지금', '아기와 분리'],
            ['주의', '무릎·안은 채 뜨거운 음료']
        ...
        blocks: [
            ['지금 할 일', '아기를 내려놓고 마시세요.'],
            ['하지 않을 일', '아이 쪽으로 컵을 두지 마세요.'],
            ['관련', '화상 안내를 참고하세요.']
        ],
        links: [
            ['CDC 화상', 'https://www.cdc.gov/burn-prevention/'],
    ...
    {
        id: 'life-jacket-size-fit-boundary',
        match: /(보트\s*구명조끼\s*사이즈|구명조끼\s*사이즈\s*아이|조끼\s*헐렁|life\s*jacket\s*size\s*fit)/,
        title: '구명조끼는 체중·사이즈에 맞게 조이고 겨드랑이에서 빼지지 않게 확인하세요',
        lead: '튜브는 구명조끼가 아닙니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['핏', '체중 표시, 잠금'],
            ['금지', '큰 성인용']
        ],
    ...
    {
        id: 'life-jacket-over-coat-boundary',
        match: /(구명조끼\s*위\s*패딩|구명조끼\s*위\s*패딩|조끼\s*겉옷\s*위|life\s*jacket\s*over\s*coat)/,
        title: '구명조끼는 두꺼운 패딩 위에 헐렁하게 입히지 말고 맞는 사이즈로 조이세요',
        lead: '튜브는 구명조끼가 아닙니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['핏', '체중 표시, 잠금'],
            ['금지', '큰 성인용']
    ...
    {
        id: 'life-jacket-water-play-boundary',
        match: /(구명조끼\s*보트\s*물놀이|life\s*jacket\s*water\s*play|구명조끼\s*보트\s*착용)/,
        title: '보트·깊은 물놀이에서는 맞는 구명조끼를 쓰고 튜브만 의지하지 마세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '맞는 사이즈·잠금'],
            ['주의', '튜브만 신뢰']
    ...
    {
        id: 'swim-lesson-fear-boundary',
        match: /(수영\s*강습\s*공포|수영\s*강습\s*공포|물\s*무서워\s*강습|swim\s*lesson\s*fear)/,
        title: '수영 강습 공포가 있으면 강요로 잠수시키지 말고 적응 속도를 조절하세요',
        lead: '강습이 익사 예방 감독을 대체하지 않습니다. 업체 순위는 하지 않습니다.',
        points: [
            ['태도', '점진, 즐거움'],
            ['금지', '강제 잠수']
        ],
    ...
    {
        id: 'neighbor-pool-visit-boundary',
        match: /(이웃\s*풀장\s*방문|이웃\s*풀장\s*방문|친구\s*집\s*수영장|neighbor\s*pool\s*visit)/,
        title: '이웃·친구 집 풀장은 울타리·감독·구명 장비를 확인하고 아이 혼자 보내지 마세요',
        lead: '성인 감독이 기본입니다.',
        points: [
            ['확인', '장벽, 감독자'],
            ['금지', '단독 방문']
    ...
    {
        id: 'pool-toys-put-away-boundary',
        match: /(풀장\s*장난감\s*치우기|풀장\s*장난감\s*치우|수영장\s*튜브\s*방치|pool\s*toys\s*put\s*away)/,
        title: '풀장 사용 후 장난감을 치워 아이가 혼자 들어가려 하지 않게 하세요',
        lead: '성인 감독과 울타리가 기본입니다.',
        points: [
            ['조치', '장난감 치우기, 문 잠금'],
            ['감독', '팔 닿는 거리']
        ],
    ...
    {
        id: 'pool-gate-latch-check-boundary',
        match: /(풀장\s*문\s*잠금\s*확인|풀장\s*문\s*잠금|pool\s*gate\s*latch)/,
        title: '가정 수영장 문은 스스로 잠기는지 확인하고 장난감을 물에 두지 마세요',
        lead: '성인 감독이 기본입니다. 제품 순위는 하지 않습니다.',
        points: [
            ['지금', '문·울타리 점검'],
            ['주의', '문 열림 방치']
        ],
    ...
    {
        id: 'tub-water-standing-boundary',
        match: /(욕조\s*물\s*받아두고|욕조\s*물\s*받아\s*두|목욕물\s*그대로|tub\s*water\s*standing\s*child)/,
        title: '욕조에 물을 받아 둔 채 자리를 비우지 말고 사용 후 물을 빼세요',
        lead: '얕은 물에서도 익사할 수 있습니다.',
        points: [
            ['습관', '물 빼기, 문 관리'],
            ['금지', '물 있는 채 방치']
        ],
        blocks: [
            ['지금 할 일', '목욕 후 즉시 배수하세요.'],
            ['하지 않을 일', '화장실 문을 열어 두지 마세요.'],
            ['관련', '물 안전 안내를 참고하세요.']
        ],
        links: [
            ['AAP 물 안전', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/Water-Safety-And-Young-Children.aspx'],
    ...
    {
        id: 'water-adult-supervision-ratio-boundary',
        match: /(물놀이\s*성인\s*비율|물놀이\s*성인\s*감독|풀장\s*보호자\s*몇\s*명|water\s*adult\s*supervision\s*ratio)/,
        title: '물놀이는 팔 닿는 거리에서 성인이 집중 감독하고 휴대폰을 보지 마세요',
        lead: '구명조끼·울타리가 감독을 대체하지 않습니다.',
        points: [
            ['감독', '집중, 팔 닿는 거리'],
            ['금지', '방치, 휴대폰']
        ],
    ...
    {
        id: 'bath-toy-standing-water-boundary',
        match: /(욕조\s*장난감\s*물|욕조\s*장난감\s*고인\s*물|목욕\s*장난감\s*물\s*방치|bath\s*toy\s*standing\s*water)/,
        title: '욕조 장난감에 고인 물은 빼고 건조하고, 목욕 후 물을 빼세요',
        lead: '얕은 물 익사·곰팡이 위험이 있습니다.',
        points: [
            ['관리', '물 빼기, 건조'],
            ['금지', '물 있는 채 방치']
        ],
        blocks: [
            ['지금 할 일', '목욕 후 바로 배수하세요.'],
            ['하지 않을 일', '아기를 욕조에 혼자 두지 마세요.'],
            ['관련', '물 안전·목욕 안내를 참고하세요.']
        ],
        links: [
            ['AAP 물 안전', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/Water-Safety-And-Young-Children.aspx'],
            ['CDC 익사', 'https://www.cdc.gov/drowning/prevention/index.html']
    ...
    {
        id: 'water-phone-distract-boundary',
        match: /(물놀이\s*휴대폰|물놀이\s*휴대폰|water\s*phone\s*distract)/,
        title: '물놀이 감독 중 휴대폰을 보지 말고 팔 닿는 거리에서 집중하세요',
    ...
    {
        id: 'bath-moment-alone-boundary',
        match: /(욕조\s*자리\s*비움|욕조\s*자리\s*비움|bath\s*moment\s*alone)/,
        title: '목욕 중 벨이 울려도 아기를 욕조에 혼자 두지 마세요',
        lead: '얕은 물에서도 익사할 수 있습니다.',
        points: [
            ['지금', '항상 팔 닿는 거리'],
            ['주의', '잠깐 자리 비움']
    ...
    {
        id: 'magnet-toy-suspect-ingest-boundary',
        match: /(자석\s*장난감\s*삼킴\s*의심\s*진료)/,
        title: '자석 장난감 개수가 줄었거나 삼킴이 의심되면 즉시 진료하세요',
        lead: '여러 개 삼킴은 특히 위험합니다.',
        points: [
            ['지금', '즉시 진료'],
            ['주의', '기다리기만 하기']
        ],
        blocks: [
            ['지금 할 일', '장난감 개수를 세어 보세요.'],
            ['하지 않을 일', '배가 아프다고만 기다리지 마세요.'],
            ['관련', '자석 삼킴 안내를 참고하세요.']
        ],
        links: [
            ['AAP 중독', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/Poison-Prevention.aspx'],
    ...
    {
        id: 'magnetic-blocks-age-boundary',
        match: /(자석\s*블럭\s*연령|자석\s*블럭\s*연령|네오디움\s*블럭\s*아이|magnetic\s*blocks\s*age)/,
        title: '강한 자석 블럭은 연령 부적합·작은 부품을 치우고 삼킴 시 즉시 진료하세요',
        lead: '여러 개 삼킴은 특히 위험합니다.',
        points: [
            ['예방', '연령 표시, 치우기'],
            ['응급', '삼킴']
    ...
    {
        id: 'magnetic-earrings-play-boundary',
        match: /(자석\s*귀걸이\s*놀이|자석\s*귀걸이\s*놀이|자석\s*피어싱\s*장난|magnetic\s*earrings\s*play\s*child)/,
        title: '자석 귀걸이·피어싱 장난감은 삼키면 위험하니 어린 아이 손에 두지 마세요',
        lead: '여러 개 삼킴은 장 손상이 날 수 있습니다.',
        points: [
            ['예방', '치우기'],
            ['응급', '삼킴']
        ],
    ...
    {
        id: 'coin-ingest-suspect-boundary',
        match: /(동전\s*삼킴\s*의심|동전\s*삼킴\s*의심|동전\s*삼켰\s*아이|coin\s*ingest\s*suspect)/,
        title: '동전 삼킴이 의심되면 증상을 보고 진료를 미루지 마세요',
        lead: '단추 배터리와 혼동될 수 있습니다.',
        points: [
            ['행동', '진료'],
            ['관찰', '침 흘림, 구토, 통증']
        ],
    ...
    {
        id: 'remote-battery-screw-boundary',
        match: /(리모컨\s*배터리\s*뚜껑\s*나사)/,
        title: '리모컨 배터리 뚜껑이 헐거우면 나사·테이프로 보강하고 삼킴 시 응급실로 가세요',
        lead: '단추 배터리는 응급입니다.',
        points: [
            ['지금', '뚜껑 고정'],
            ['주의', '삼킴 방치']
    ...
    {
        id: 'earbud-case-battery-boundary',
        match: /(이어폰\s*케이스\s*배터리|이어폰\s*케이스\s*배터리|버즈\s*배터리\s*아이|earbud\s*case\s*battery\s*child)/,
        title: '이어폰·스마트 기기 속 단추 배터리를 분해하지 못하게 하세요',
        lead: '삼킴은 응급입니다.',
        points: [
            ['예방', '분해 금지, 보관'],
            ['응급', '삼킴 의심']
    ...
    {
        id: 'musical-book-battery-boundary',
        match: /(노래하는\s*책\s*배터리|노래하는\s*책\s*배터리|사운드\s*북\s*건전지|musical\s*book\s*battery)/,
        title: '노래하는 책·카드의 단추 배터리 칸이 헐거우면 보강하고 삼킴 시 즉시 응급실로 가세요',
        lead: '단추 배터리는 응급입니다.',
        points: [
            ['예방', '뚜껑 고정'],
            ['응급', '삼킴 의심']
    ...
    {
        id: 'tick-removal-method-remind-boundary',
        match: /(진드기\s*핀셋\s*제거|tick\s*removal\s*method\s*remind|진드기\s*제거\s*자세)/,
        title: '진드기는 핀셋으로 머리 가까이를 잡고 수직으로 빼고, 민간 요법을 쓰지 마세요',
        lead: '제거 후 부위를 관찰하고 이상하면 진료하세요.',
        points: [
            ['방법', '핀셋, 수직'],
            ['금지', '불·오일·비틀기']
        ],
    ...
    {
        id: 'repellent-face-application-boundary',
        match: /(모기\s*기피제\s*얼굴|기피제\s*얼굴\s*바르|모기\s*스프레이\s*얼굴|repellent\s*face\s*apply)/,
        title: '기피제는 손에 뿌려 얼굴에 펴 바르고 눈·입에 들어가지 않게 하세요',
        lead: '연령·성분 표시를 확인하세요. 브랜드 순위·용량 단정은 하지 않습니다.',
        points: [
            ['방법', '손→얼굴'],
            ['금지', '얼굴 직분무']
        ],
    ...
    {
        id: 'repellent-handwash-after-boundary',
        match: /(모기\s*기피제\s*손\s*씻기|기피제\s*바르고\s*손\s*씻|모기\s*스프레이\s*후\s*손|repellent\s*handwash\s*after)/,
        title: '기피제를 손에 바른 뒤 음식 전 손을 씻고 눈·입에 들어가지 않게 하세요',
        lead: '연령·성분 표시를 확인하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['사용', '표시 준수'],
            ['위생', '손 씻기']
        ],
        blocks: [
            ['지금 할 일', '얼굴은 손에 뿌려 펴 바르세요.'],
            ['하지 않을 일', '과다 분사하지 마세요.'],
            ['관련', '기피제 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'repellent-age-label-boundary',
        match: /(모기\s*기피제\s*연령|기피제\s*연령\s*표시|repellent\s*age\s*label)/,
        title: '모기 기피제는 연령·성분 표시를 확인하고 얼굴에 직접 뿌리지 마세요',
        lead: '브랜드 순위·용량 단정은 하지 않습니다.',
        points: [
            ['지금', '표시 준수'],
            ['주의', '얼굴 직분무']
    ...
    {
        id: 'bee-sting-ice-boundary',
        match: /(벌\s*쏘인\s*후\s*얼음|벌\s*쏘인\s*후\s*얼음|벌침\s*얼음찜질|bee\s*sting\s*ice)/,
        title: '벌에 쏘인 뒤 침을 제거하고 차갑게 하며 전신 증상이면 응급 진료하세요',
        lead: '알레르기 병력이 있으면 더 주의하세요. 약 용량은 의료진을 따르세요.',
        points: [
            ['즉시', '침 제거, 세척'],
            ['응급', '호흡, 전신 두드러기']
        ],
        blocks: [
            ['지금 할 일', '침을 밀어 빼지 말고 긁어내듯 제거하세요.'],
            ['하지 않을 일', '호흡 이상을 무시하지 마세요.'],
            ['관련', '벌 쏘임 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'stutter-mocking-boundary',
        match: /(말\s*더듬\s*웃기기|말\s*더듬\s*웃기|더듬이\s*놀림|stutter\s*mocking)/,
        title: '말 더듬을 놀리거나 웃기지 말고 여유 있게 들으세요',
        lead: '지속·악화면 전문가 상담을 검토하세요.',
        points: [
            ['태도', '경청, 서두르지 않기'],
            ['금지', '놀림, 재촉']
        ],
    ...
    {
        id: 'no-babbling-concern-boundary',
        match: /(옹알이\s*없음\s*걱정|옹알이\s*없음|옹알\s*안\s*해|no\s*babbling\s*concern)/,
        title: '옹알이가 없거나 또래와 차이가 크면 청력·발달 평가를 미루지 마세요',
        lead: '한 가지로 장애를 단정하지 않습니다.',
        points: [
            ['관찰', '소리 반응, 제스처'],
            ['상담', '지속 걱정']
        ],
    ...
    {
        id: 'word-count-worry-boundary',
        match: /(단어\s*개수\s*걱정|단어\s*개수\s*걱정|말이\s*몇\s*개|word\s*count\s*worry)/,
        title: '단어 개수 하나만으로 늦음을 단정하지 말고 이해·제스처·청력을 함께 보세요',
        lead: '걱정이 계속되면 평가를 검토하세요. 앱 진단은 하지 않습니다.',
        points: [
            ['관찰', '이해, 제스처'],
            ['상담', '지속 걱정']
        ],
    ...
    {
        id: 'receptive-language-ok-boundary',
        match: /(말\s*이해는\s*되는데|말\s*이해는\s*되는데|receptive\s*language\s*ok)/,
        title: '이해는 되는데 표현이 적다면 청력·전체 발달을 함께 평가하세요',
        lead: '한 가지로 장애를 단정하지 않습니다.',
        points: [
            ['지금', '이해·표현 기록'],
            ['주의', '비교만으로 단정']
    ...
    {
        id: 'stutter-slow-down-pressure-boundary',
        match: /(말\s*더듬\s*천천히|말\s*더듬\s*천천히\s*말해|더듬을\s*때\s*천천히|stutter\s*slow\s*down\s*pressure)/,
        title: '말 더듬을 지적하며 천천히 말하라고 재촉하기보다 여유 있게 들으세요',
        lead: '지속·악화면 상담을 검토하세요.',
        points: [
            ['태도', '경청'],
            ['금지', '놀림, 재촉']
        ],
    ...
    {
        id: 'stutter-duration-when-eval-boundary',
        match: /(말\s*더듬\s*기간|말\s*더듬\s*기간|stutter\s*duration\s*eval)/,
        title: '말 더듬이 오래가거나 심해지면 전문가 상담을 검토하세요',
        lead: '지적·재촉을 피하세요.',
        points: [
            ['지금', '경청·상담'],
            ['주의', '놀림']
    ...
    {
        id: 'bedroom-door-ajar-boundary',
        match: /(잠자리\s*문\s*열어두기|잠자리\s*문\s*열어|방문\s*조금\s*열고\s*재우|bedroom\s*door\s*ajar)/,
        title: '어둠 공포에 문을 조금 열어 두는 것은 선택이나 안전·소음을 함께 보세요',
        lead: '수면등·루틴이 도움이 될 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['환경', '은은한 빛, 루틴'],
            ['안전', '전선, 낙하물']
        ],
        blocks: [
            ['지금 할 일', '함께 방을 확인해 주세요.'],
            ['하지 않을 일', '공포 이야기로 겁주지 마세요.'],
            ['관련', '어둠 공포 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'bedtime-monster-check-boundary',
        match: /(잠자리\s*검사\s*루틴|잠자리\s*괴물\s*확인|bedtime\s*monster\s*check)/,
        title: '방에 대한 공포에는 짧게 함께 확인하는 루틴이 도움이 될 수 있습니다',
        lead: '조롱하지 마세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '함께 확인·루틴'],
            ['주의', '겁주기']
        ],
    ...
    {
        id: 'night-terror-do-not-wake-boundary',
        match: /(야경\s*중\s*깨우기|야경\s*중\s*깨우기|야경\s*깨우면\s*안돼|night\s*terror\s*do\s*not\s*wake)/,
        title: '야경처럼 보이면 억지로 깨우기보다 안전을 확보하고 패턴을 기록하세요',
        lead: '악몽과 구분이 필요하면 진료와 상담하세요.',
        points: [
            ['대응', '안전, 관찰'],
            ['피하기', '세게 흔들어 깨우기']
        ],
    ...
    {
        id: 'night-terror-no-memory-boundary',
        match: /(야경\s*후\s*아침\s*기억|야경\s*기억\s*없음|night\s*terror\s*no\s*memory)/,
        title: '야경 후 기억을 못 하는 경우가 많아 아침에 길게 추궁하지 마세요',
        lead: '위험 행동을 막고 패턴을 기록하세요.',
        points: [
            ['지금', '안전·기록'],
            ['주의', '세게 깨워 심문']
        ],
    ...
    {
        id: 'adult-cold-med-child-boundary',
        match: /(감기약\s*성인\s*소량|성인\s*감기약\s*소량\s*아이|어른\s*약\s*아이|adult\s*cold\s*med\s*child)/,
        title: '성인 감기약을 소량 나눠 주지 말고 연령 표시·의료진을 따르세요',
        lead: '어린 아이 시판 감기약은 제한 안내가 많습니다.',
        points: [
            ['원칙', '의료진 상담'],
            ['금지', '성인약 분할']
        ],
    ...
    {
        id: 'otc-cold-pharmacy-push-boundary',
        match: /(감기약\s*약국\s*권유|감기약\s*약국\s*권유|otc\s*cold\s*pharmacy)/,
        title: '약국에서 권하는 감기약도 연령 표시·의료진 상담을 우선하세요',
        lead: '어린 아이 시판 감기약은 제한 안내가 많습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '연령·상담'],
            ['주의', '성인약 소량']
        ],
    ...
    {
        id: 'parking-lot-cart-hold-boundary',
        match: /(마트\s*주차장\s*카트|주차장\s*카트\s*손|마트\s*주차장\s*뛰어|parking\s*lot\s*cart\s*hold)/,
        title: '주차장에서는 손을 잡고 카트 벨트를 채우며 차량 사이로 뛰지 않게 하세요',
        lead: '후진 차량을 주의하세요.',
        points: [
            ['이동', '손잡기, 벨트'],
            ['금지', '뛰어다님']
    ...
    {
        id: 'traffic-light-teach-boundary',
        match: /(신호등\s*건너기\s*교육|신호등\s*건너기\s*교육|횡단보도\s*가르치|traffic\s*light\s*teach\s*child)/,
        title: '횡단보도에서는 손을 잡고 좌우를 확인하는 습관을 함께 연습하세요',
        lead: '초록불이어도 차량을 확인하세요.',
        points: [
            ['습관', '손잡기, 확인'],
            ['금지', '뛰어 건너기']
        ],
        blocks: [
            ['지금 할 일', '함께 좌우를 말하며 보세요.'],
            ['하지 않을 일', '주차 차량 사이로 뛰지 마세요.'],
            ['관련', '횡단보도 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'rainy-crosswalk-boundary',
        match: /(비\s*오는\s*날\s*횡단|비\s*오는\s*날\s*횡단|우천\s*횡단보도\s*아이|rainy\s*crosswalk\s*child)/,
        title: '비 오는 날 횡단은 손을 잡고 서행 차량을 더 주의하세요',
        lead: '시야·제동이 나빠집니다.',
        points: [
            ['이동', '손잡기, 확인'],
            ['금지', '뛰어 건너기']
    ...
    {
        id: 'crosswalk-no-run-boundary',
        match: /(횡단보도\s*뛰어가기|횡단보도\s*뛰어|crosswalk\s*no\s*run)/,
        title: '횡단보도에서 뛰어 건너지 않게 손을 잡고 천천히 건너세요',
        lead: '초록불이어도 차량을 확인하세요.',
        points: [
            ['지금', '손잡기·확인'],
            ['주의', '뛰어 건너기']
    ...
    {
        id: 'driveway-child-behind-car-boundary',
        match: /(주차\s*후진\s*아이|후진\s*아이\s*뒤|주차\s*아이\s*차\s*뒤|driveway\s*child\s*behind)/,
        title: '후진 전 차 뒤와 주변을 직접 확인하고 아이를 차 뒤에 두지 마세요',
        lead: '카메라만 과신하지 마세요.',
        points: [
            ['확인', '직접 시야'],
            ['금지', '차 뒤 놀이']
        ...
        blocks: [
            ['지금 할 일', '출발 전 주변을 걸으세요.'],
            ['하지 않을 일', '아이 혼자 차 옆에 두지 마세요.'],
            ['관련', '후진·주차장 안내를 참고하세요.']
        ],
        links: [
            ['AAP 차량', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/default.aspx'],
    ...
    {
        id: 'garage-backover-check-boundary',
        match: /(차고\s*후진\s*확인|차고\s*후진|garage\s*backover)/,
        title: '차고·차로에서 후진 전 차 뒤를 직접 확인하세요',
        lead: '카메라만 과신하지 마세요.',
        points: [
            ['지금', '직접 시야'],
            ['주의', '차 뒤 놀이']
    ...
    {
        id: 'sleeping-child-in-car-boundary',
        match: /((잠든\s*아이\s*차\s*안|차에서\s*재우\s*아이|sleeping\s*child\s*in\s*car))/,
        title: '잠든 아이를 차에 혼자 두지 말고, 도착 후 바로 함께 내리세요',
        lead: '온도·방치 위험이 큽니다.',
        points: [
            ['원칙', '항상 함께'],
            ['금지', '잠깐 혼자']
    ...
    {
        id: 'convenience-store-child-car-boundary',
        match: /(편의점\s*아이\s*차\s*혼자)/,
        title: '편의점 짧은 볼일에도 아이를 차에 혼자 두지 마세요',
        lead: '온도·방치 위험이 있습니다.',
        points: [
            ['지금', '항상 함께'],
            ['주의', '잠깐 혼자']
    ...
    {
        id: 'quick-errand-child-in-car-boundary',
        match: /(짧은\s*심부름\s*차\s*아이|짧은\s*심부름\s*차\s*아이|편의점\s*아이\s*차|quick\s*errand\s*child\s*car)/,
        title: '짧은 심부름에도 아이를 차에 혼자 두지 마세요',
        lead: '온도·납치·차량 이동 위험이 있습니다.',
        points: [
            ['원칙', '항상 함께'],
            ['금지', '잠깐 혼자']
        ],
    ...
    {
        id: 'backseat-check-habit-boundary',
        match: /(카시트\s*확인\s*습관|뒷좌석\s*확인\s*습관|backseat\s*check\s*habit)/,
        title: '하차 시 뒷좌석을 확인하는 습관으로 아이를 두고 내리는 일을 막으세요',
        lead: '바쁜 일정에 사고가 납니다.',
        points: [
            ['지금', '뒷좌석 확인'],
            ['주의', '확인 생략']
        ...
        blocks: [
            ['지금 할 일', '도착 시 뒷좌석을 보세요.'],
            ['하지 않을 일', '가방을 뒷좌석에 두는 방법도 검토하세요.'],
            ['관련', '차 안 방치 안내를 참고하세요.']
        ],
        links: [
            ['AAP 차량', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/default.aspx'],
    ...
    {
        id: 'dresser-heavy-bottom-boundary',
        match: /(서랍장\s*무게\s*아래|서랍장\s*무게\s*아래|무거운\s*옷\s*아래\s*서랍|dresser\s*heavy\s*bottom)/,
        title: '서랍장은 무거운 물건을 아래에 두고 벽에 고정하세요',
        lead: '전도 사고가 중대합니다. 앵커 브랜드 순위는 하지 않습니다.',
        points: [
            ['고정', '벽 앵커'],
            ['배치', '무게 아래']
    ...
    {
        id: 'bookshelf-top-decor-boundary',
        match: /(책장\s*위\s*장식|책장\s*위\s*장식|높은\s*선반\s*장식\s*아이|bookshelf\s*top\s*decor)/,
        title: '책장 위 장식은 올라가려는 유인이 되니 치우고 가구를 벽에 고정하세요',
        lead: '전도 사고가 중대합니다. 앵커 브랜드 순위는 하지 않습니다.',
        points: [
            ['고정', '벽 앵커'],
            ['배치', '유인물 제거']
    ...
    {
        id: 'dresser-all-drawers-open-boundary',
        match: /(서랍\s*전부\s*열기|서랍\s*전부\s*열|dresser\s*all\s*drawers)/,
        title: '서랍을 한꺼번에 열면 전복될 수 있어 막고 가구를 벽에 고정하세요',
        lead: '앵커 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '벽 고정·한 칸씩'],
            ['주의', '여러 서랍 동시 개방']
        ],
    ...
    {
        id: 'tv-cord-pull-boundary',
        match: /(티비\s*줄\s*당김\s*전복)/,
        title: 'TV·셋톱 전선을 당겨 전복되지 않게 코드를 정리·고정하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '코드 정리·앵커'],
            ['주의', '줄 당기기 놀이']
    ...
    {
        id: 'tv-shelf-edge-boundary',
        match: /(티비\s*선반\s*가장자리|tv\s*선반\s*가장자리|tv\s*shelf\s*edge|티비\s*앞으로\s*빼)/,
        title: 'TV를 선반 끝에 두지 말고 고정·중심을 맞추세요',
        lead: '당겨 전복될 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['배치', '안쪽, 앵커'],
            ['금지', '불안정 가장자리']
        ],
    ...
    {
        id: 'hotel-window-child-safety-boundary',
        match: /(호텔\s*창\s*안전|호텔\s*창\s*안전|숙소\s*창문\s*아이|hotel\s*window\s*child\s*safety)/,
        title: '호텔 창·발코니는 문을 잠그고 가구를 난간 쪽에 붙이지 마세요',
        lead: '아이 혼자 두지 마세요.',
        points: [
            ['차단', '문 잠금'],
            ['배치', '가구 이동']
        ...
        blocks: [
            ['지금 할 일', '도착 직후 잠금을 확인하세요.'],
            ['하지 않을 일', '의자 위에 올라가게 두지 마세요.'],
            ['관련', '창문 낙상 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'hotel-railing-furniture-boundary',
        match: /(호텔\s*난간\s*가구|호텔\s*난간\s*가구|hotel\s*railing\s*furniture)/,
        title: '호텔 난간 옆에 의자를 두지 말고 발코니 문을 잠그세요',
        lead: '아이 혼자 두지 마세요.',
        points: [
            ['지금', '문 잠금·가구 이동'],
            ['주의', '난간 옆 의자']
    ...
    {
        id: 'screen-lean-window-boundary',
        match: /(창문\s*방충망\s*기대기\s*위험)/,
        title: '방충망에 기대지 않게 하고 창 잠금·가구 배치를 우선하세요',
        lead: '방충망은 낙상 방지 장치가 아닙니다.',
        points: [
            ['지금', '창 잠금·가구 이동'],
            ['주의', '방충망 과신']
        ],
        blocks: [
            ['지금 할 일', '아이 방 창을 점검하세요.'],
    ...
    {
        id: 'window-sill-climb-boundary',
        match: /(창틀\s*올라가기|창틀\s*올라|창문\s*난간\s*앉|window\s*sill\s*climb)/,
        title: '창틀·난간에 올라앉지 않게 하고 가구를 창에서 멀리 두세요',
        lead: '방충망은 장벽이 아닙니다.',
        points: [
            ['조치', '가구 이동, 잠금'],
            ['금지', '창틀 앉기']
        ...
        blocks: [
            ['지금 할 일', '아이 방 창을 점검하세요.'],
            ['하지 않을 일', '창문을 활짝 연 채 자리를 비우지 마세요.'],
            ['관련', '창문 낙상 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'sofa-by-window-boundary',
        match: /(창가\s*소파|창가\s*소파|창문\s*앞\s*소파\s*아이|sofa\s*by\s*window\s*child)/,
        title: '창문 앞 소파·가구는 올라 낙상할 수 있어 배치를 바꾸세요',
        lead: '방충망은 장벽이 아닙니다.',
        points: [
            ['배치', '가구 이동'],
            ['잠금', '창 스토퍼']
    ...
    {
        id: 'cat-scratch-clean-boundary',
        match: /(고양이\s*할퀴\s*소독\s*방법)/,
        title: '고양이에게 할퀴면 비누로 씻고 감염 징후를 보며 심하면 진료하세요',
        lead: '사진 진단은 하지 않습니다.',
        points: [
            ['지금', '세척·관찰'],
            ['주의', '방치']
    ...
    {
        id: 'farm-boots-handwash-boundary',
        match: /(목장\s*장화\s*후\s*손|목장\s*장화\s*손\s*씻|농장\s*방문\s*손|farm\s*boots\s*handwash)/,
        title: '농장·목장 방문 후에는 손을 씻고 신발 흙이 입에 닿지 않게 하세요',
        lead: '가축 주변 감염·발 차임을 조심하세요.',
        points: [
            ['위생', '손 씻기'],
            ['거리', '발 차임']
        ],
    ...
    {
        id: 'farm-touch-then-eat-boundary',
        match: /(동물\s*만진\s*후\s*음식|동물\s*만진\s*후\s*음식|농장\s*손\s*씻고\s*먹|farm\s*touch\s*then\s*eat)/,
        title: '동물을 만진 뒤 음식을 먹기 전 손을 씻으세요',
        lead: '가축 주변 감염 위험이 있을 수 있습니다.',
        points: [
            ['위생', '손 씻기'],
            ['거리', '발 차임, 물림']
        ],
    ...
    {
        id: 'farm-shoes-off-boundary',
        match: /(목장\s*신발\s*벗기|목장\s*신발|farm\s*shoes\s*off)/,
        title: '목장·농장 방문 후 신발 흙이 입에 닿지 않게 하고 손을 씻으세요',
        lead: '가축 주변 감염·발 차임을 조심하세요.',
        points: [
            ['지금', '손 씻기·신발 관리'],
            ['주의', '만진 손 입']
    ...
    {
        id: 'zoo-feeding-rule-boundary',
        match: /(동물원\s*먹이주기|동물원\s*먹이주기|동물\s*먹이\s*체험\s*규칙|zoo\s*feeding\s*rule)/,
        title: '동물원 먹이 체험은 안내를  strictly 따르고 손 씻기와 울타리 규칙을 지키세요',
        lead: '동물원 먹이 체험은 시설 안내를 따르고 손 씻기와 울타리 규칙을 지키세요',
        points: [
            ['규칙', '안내원, 울타리'],
            ['위생', '손 씻기']
        ],
    ...
    {
        id: 'zoo-stroller-policy-boundary',
        match: /(동물원\s*유모차|동물원\s*유모차\s*정책|동물원\s*유모차\s*가능|zoo\s*stroller\s*policy)/,
        title: '동물원 유모차는 시설 규정을 확인하고 울타리·혼잡을 조심하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['확인', '시설 규정'],
            ['감독', '손잡기, 벨트']
    ...
    {
        id: 'zoo-handwash-after-boundary',
        match: /(동물원\s*손\s*씻기|동물원\s*손\s*씻기|zoo\s*handwash)/,
        title: '동물원 체험 후 손을 씻고 울타리 규칙을 지키세요',
        lead: '무단 먹이 주기를 하지 마세요.',
        points: [
            ['지금', '손 씻기·규칙'],
            ['주의', '우리 안 손']
        ],
    ...
    {
        id: 'park-bird-feeding-boundary',
        match: /(공원\s*새\s*먹이\s*손으로)/,
        title: '공원 야생 새에게 손으로 먹이를 주지 말고 손을 씻으세요',
        lead: '물림·감염 위험이 있을 수 있습니다.',
        points: [
            ['지금', '거리·손 씻기'],
            ['주의', '손 먹이']
        ],
    ...
    {
        id: 'pigeon-feeding-child-boundary',
        match: /(비둘기\s*먹이\s*주기\s*아이|비둘기\s*먹이\s*주기\s*아이|공원\s*새\s*먹이|pigeon\s*feeding\s*child)/,
        title: '야생 새·비둘이에게 먹이를 주거나 만지지 않게 하고 손 씻기를 하세요',
        lead: '감염·물림 위험이 있을 수 있습니다.',
        points: [
            ['규칙', '만지지 않기'],
            ['위생', '손 씻기']
        ],
    ...
    {
        id: 'squirrel-feeding-child-boundary',
        match: /(다람쥐\s*먹이\s*주기|다람쥐\s*먹이\s*주기|공원\s*다람쥐\s*손|squirrel\s*feeding\s*child)/,
        title: '야생 다람쥐·새에게 손으로 먹이를 주지 말고 물림·감염을 피하세요',
        lead: '거리를 두세요.',
        points: [
            ['규칙', '만지지 않기'],
            ['위생', '손 씻기']
    ...
    {
        id: 'dog-running-at-child-boundary',
        match: /(산책\s*중\s*개\s*달려옴|개\s*달려옴\s*아이|산책\s*개\s*공격|dog\s*running\s*at\s*child)/,
        title: '개가 달려오면 아이를 들어 올리거나 뒤로 두고 자극하지 마세요',
        lead: '돌·막대로 때리면 더 위험할 수 있습니다.',
        points: [
            ['행동', '아이 보호, 거리'],
            ['금지', '뛰어 쫓아가기']
        ],
    ...
    {
        id: 'unleashed-dog-child-boundary',
        match: /(목줄\s*없는\s*개|목줄\s*없는\s*개|개\s*목줄\s*없이|unleashed\s*dog\s*child)/,
        title: '목줄 없는 개에게 다가가지 말고 아이를 보호한 채 거리를 두세요',
        lead: '자극하면 더 위험할 수 있습니다.',
        points: [
            ['행동', '거리, 아이 보호'],
            ['금지', '쫓아가기, 먹이']
        ],
    ...
    {
        id: 'park-dog-leash-boundary',
        match: /(공원\s*개\s*목줄|공원\s*개\s*목줄|park\s*dog\s*leash)/,
        title: '공원에서 목줄 없는 개에게 다가가지 말고 거리를 두세요',
        lead: '자극하면 더 위험할 수 있습니다.',
        points: [
            ['지금', '거리·보호'],
            ['주의', '쫓아가기']
    ...
    {
        id: 'hamster-wake-bite-boundary',
        match: /(햄스터\s*잠든\s*깨우기|햄스터\s*잠든\s*깨우|햄스터\s*자다가\s*물|hamster\s*wake\s*bite)/,
        title: '잠든 햄스터를 갑자기 깨우지 말고 물리면 씻고 감염을 관찰하세요',
        lead: '심하거나 깊으면 진료하세요.',
        points: [
            ['예방', '갑자기 깨우지 않기'],
            ['상처', '세척']
    ...
    {
        id: 'aquarium-cord-safety-boundary',
        match: /(어항\s*전기\s*코드|어항\s*전기\s*코드|수조\s*전선\s*아이|aquarium\s*cord\s*child)/,
        title: '어항 전선·히터는 아이 손이 닿지 않게 정리하고 물과 전기를 분리하세요',
        lead: '전복·감전 위험이 있습니다.',
        points: [
            ['배치', '코드 정리, 고정'],
            ['위생', '손 씻기']
    ...
    {
        id: 'aquarium-water-drink-boundary',
        match: /(어항\s*물\s*마심|어항\s*물\s*마심|aquarium\s*water\s*drink)/,
        title: '어항 물을 마시지 않게 하고 만진 뒤 손을 씻기세요',
        lead: '전복·감전도 조심하세요.',
        points: [
            ['지금', '거리·손 씻기'],
            ['주의', '물 가지고 놀기']
    ...
    {
        id: 'adopt-dog-with-infant-boundary',
        match: /(아기\s*있는\s*집\s*강아지\s*입양|아기\s*있는\s*집\s*강아지\s*입양|신생아\s*반려견\s*입양|adopt\s*dog\s*with\s*infant)/,
        title: '아기가 있는 집 반려 입양은 성격·훈련·감독 계획을 세우고 단독 방치를 하지 마세요',
        lead: '수면 공간은 분리하세요. 업체 순위는 하지 않습니다.',
        points: [
            ['계획', '점진 소개, 감독'],
            ['금지', '단독 방']
        ],
    ...
    {
        id: 'dog-adoption-infant-sleep-boundary',
        match: /(강아지\s*입양\s*아기\s*수면|강아지\s*입양\s*아기\s*수면|반려견\s*아기\s*침대|dog\s*adoption\s*infant\s*sleep)/,
        title: '반려견이 있는 집 아기 수면 공간은 분리하고 단독 방치를 하지 마세요',
        lead: '안전수면 원칙을 지키세요.',
        points: [
            ['분리', '아기 침대 공간'],
            ['금지', '개와 함께 재우기']
        ...
        blocks: [
            ['지금 할 일', '문을 닫아 수면 공간을 지키세요.'],
            ['하지 않을 일', '아기와 개를 방에 혼자 두지 마세요.'],
            ['관련', '물림·수면 안내를 참고하세요.']
        ],
        links: [
            ['AAP 수면', 'https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/default.aspx'],
    ...
    {
        id: 'new-puppy-with-baby-boundary',
        match: /(아기\s*앞\s*새\s*강아지|아기\s*앞\s*새\s*강아지|new\s*puppy\s*with\s*baby)/,
        title: '아기 앞에서 새 강아지를 소개할 때는 짧고 감독 아래 하고 단독 방치를 하지 마세요',
        lead: '수면 공간은 분리하세요.',
        points: [
            ['지금', '점진·감독'],
            ['주의', '단독 방']
    ...
    {
        id: 'cat-belly-touch-boundary',
        match: /(고양이\s*배\s*만지기|고양이\s*배\s*만지|고양이\s*배\s*공격|cat\s*belly\s*touch)/,
        title: '고양이 배를 억지로 만지지 않게 하고 할퀴면 씻은 뒤 감염을 관찰하세요',
        lead: '심하면 진료하세요.',
        points: [
            ['예방', '거친 놀이 금지'],
            ['상처', '세척']
    ...
    {
        id: 'cat-claw-trim-child-boundary',
        match: /(고양이\s*발톱\s*관리|고양이\s*발톱\s*관리|고양이\s*발톱\s*깎|cat\s*claw\s*trim\s*child)/,
        title: '고양이 발톱 관리는 성인이 하고 아이가 거칠게 놀지 않게 하세요',
        lead: '할퀴면 씻고 감염을 관찰하세요.',
        points: [
            ['예방', '거친 놀이 금지'],
            ['상처', '세척']
        ],
        blocks: [
            ['지금 할 일', '배를 세게 만지지 마세요.'],
            ['하지 않을 일', '할퀸 상처를 방치하지 마세요.'],
            ['관련', '고양이 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'dog-chew-bone-child-boundary',
        match: /(개\s*뼈\s*간식\s*아이|개\s*뼈\s*간식\s*아이|강아지\s*츄\s*빼앗|dog\s*chew\s*bone\s*child)/,
        title: '개가 뼈·츄를 먹을 때 아이가 다가가 빼앗지 않게 하세요',
        lead: '자원 보호로 물릴 수 있습니다.',
        points: [
            ['규칙', '식사·간식 중 거리'],
            ['환경', '분리']
        ],
    ...
    {
        id: 'dog-training-session-child-boundary',
        match: /(개\s*훈련\s*중\s*아이|개\s*훈련\s*중\s*아이|반려견\s*교육\s*아기|dog\s*training\s*child\s*near)/,
        title: '반려견 훈련 중에는 아이를 가까이 두지 말고 흥분·교정을 피하세요',
        lead: '훈련 업체 순위는 하지 않습니다.',
        points: [
            ['거리', '아이 분리'],
            ['금지', '훈련 중 만지기']
        ],
        blocks: [
            ['지금 할 일', '훈련이 끝난 뒤 소개하세요.'],
            ['하지 않을 일', '먹이·교정 도구를 아이 손에 주지 마세요.'],
            ['관련', '물림 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'dog-greeting-teach-boundary',
        match: /(개\s*인사\s*방법|개\s*인사\s*방법\s*아이|반려견\s*만나\s*인사|dog\s*greeting\s*teach)/,
        title: '개를 만날 때 머리 위를 덮치지 않게 가르치고 모르는 개는 만지지 마세요',
        lead: '주인 허락과 개 신호를 보세요.',
        points: [
            ['규칙', '허락, 천천히'],
            ['금지', '갑자기 만지기']
        ],
    ...
    {
        id: 'dog-head-pat-boundary',
        match: /(개\s*만질\s*때\s*머리|개\s*머리\s*쓰다듬|dog\s*head\s*pat)/,
        title: '개를 만질 때 머리 위를 덮치지 않게 가르치고 허락을 받으세요',
        lead: '먹는 중·잠든 개를 깨우지 마세요.',
        points: [
            ['지금', '허락·천천히'],
            ['주의', '갑자기 만지기']
        ],
    ...
    {
        id: 'bead-in-nose-boundary',
        match: /(코에\s*구슬|코에\s*구슬|콧속\s*구슬\s*넣|bead\s*in\s*nose\s*child)/,
        title: '코·귀에 구슬 등 이물이 있으면 억지로 파내지 말고 진료하세요',
        lead: '배터리·자석은 응급입니다.',
        points: [
            ['금지', '집에서 깊게 파기'],
            ['진료', '이물 의심']
        ...
        blocks: [
            ['지금 할 일', '숨을 세게 푸는 정도만 시도해 볼 수 있습니다.'],
            ['하지 않을 일', '핀셋으로 깊이 넣지 마세요.'],
            ['관련', '이물 안내를 참고하세요.']
        ],
        links: [
            ['AAP 건강', 'https://www.healthychildren.org/English/health-issues/conditions/Pages/default.aspx'],
    ...
    {
        id: 'sports-day-heat-plan-boundary',
        match: /(운동회\s*더위\s*대처)/,
        title: '운동회·체육대회 더위에는 그늘·물·휴식을 챙기고 이상 증상 시 중단하세요',
        lead: '어지럼·구토·의식 변화는 진료를 검토하세요.',
        points: [
            ['예방', '그늘, 물, 휴식'],
            ['중단', '처짐, 구토']
        ],
        blocks: [
            ['지금 할 일', '물을 자주 마시게 하세요.'],
    ...
    {
        id: 'thunder-no-swim-boundary',
        match: /(천둥\s*칠\s*때\s*수영|천둥\s*수영\s*금지|번개\s*풀장|thunder\s*no\s*swim)/,
        title: '천둥·번개가 있으면 수영·야외 물놀이를 즉시 중단하고 실내로 대피하세요',
        lead: '물이 있는 열린 공간은 위험합니다.',
        points: [
            ['즉시', '물에서 나옴, 실내'],
            ['금지', '나무 아래 대피']
        ],
        blocks: [
            ['지금 할 일', '천둥이 들리면 바로 나오세요.'],
            ['하지 않을 일', '번개 칠 때 물가에 있지 마세요.'],
            ['관련', '번개·물 안전 안내를 참고하세요.']
        ],
        links: [
            ['AAP 물 안전', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/Water-Safety-And-Young-Children.aspx'],
            ['AAP 놀이', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/default.aspx']
    ...
    {
        id: 'thunder-go-indoors-boundary',
        match: /(천둥\s*칠\s*때\s*야외|천둥\s*야외\s*중단|thunder\s*go\s*indoors)/,
    ...
    {
        id: 'outdoor-class-heat-boundary',
        match: /(야외\s*수업\s*더위|야외\s*수업\s*더위|체험학습\s*폭염|outdoor\s*class\s*heat)/,
        title: '야외 수업·체험학습 더위에는 그늘·물·휴식을 챙기고 이상 시 중단하세요',
        lead: '어지럼·구토·의식 변화는 진료를 검토하세요.',
        points: [
            ['예방', '그늘, 물'],
            ['중단', '처짐, 구토']
    ...
    {
        id: 'outdoor-event-heat-boundary',
        match: /(야외\s*행사\s*더위|야외\s*행사\s*더위|outdoor\s*event\s*heat)/,
        title: '야외 행사 더위에는 그늘·물·휴식을 챙기고 이상 증상 시 중단하세요',
        lead: '어지럼·구토·의식 변화는 진료를 검토하세요.',
        points: [
            ['지금', '그늘·물'],
            ['주의', '한낮 장시간']
    ...
    {
        id: 'trampoline-single-user-rule-boundary',
        match: /((트램폴린\s*한\s*명\s*규칙|트램폴린\s*동시\s*금지|trampoline\s*single\s*user\s*rule))/,
        title: '트램폴린은 한 명씩, 감독 아래, 공중제비 없이 이용하세요',
        lead: '여러 명 충돌 부상이 늘어납니다.',
        points: [
            ['규칙', '한 명, 감독'],
            ['점검', '그물, 패딩']
        ],
    ...
    {
        id: 'home-trampoline-risk-boundary',
        match: /(트램폴린\s*가정\s*보험|가정\s*트램폴린\s*위험|마당\s*트램폴린\s*보험|home\s*trampoline\s*risk)/,
        title: '가정 트램폴린은 부상 위험이 커 한 명 규칙·감독·안전망을 지키고 설치를 재고하세요',
        lead: 'AAP 등 많은 안내가 가정 트램폴린을 권하지 않습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['규칙', '한 명, 감독'],
            ['점검', '그물, 패딩']
        ],
        blocks: [
            ['지금 할 일', '여러 명이 동시에 뛰지 마세요.'],
            ['하지 않을 일', '공중제비를 하지 마세요.'],
            ['관련', '트램폴린 안내를 참고하세요.']
        ],
        links: [
            ['AAP 트램폴린', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/Trampolines-What-You-Need-to-Know.aspx'],
    ...
    {
        id: 'trampoline-flip-ban-boundary',
        match: /(트램폴린\s*공중제비|트램폴린\s*공중제비|trampoline\s*flip)/,
        title: '트램폴린에서 공중제비·여러 명 동시 이용을 하지 마세요',
        lead: '한 명·감독 규칙이 중요합니다.',
        points: [
            ['지금', '한 명·감독'],
            ['주의', '공중제비·과적']
        ],
    ...
    {
        id: 'helmet-off-for-photo-boundary',
        match: /(헬멧\s*벗고\s*사진|헬멧\s*벗고\s*사진|사진\s*찍으려\s*헬멧|helmet\s*off\s*photo)/,
        title: '자전거·보드 이용 중 사진 때문에 헬멧을 벗기지 마세요',
        lead: '잠깐도 위험이 있습니다.',
        points: [
            ['원칙', '이용 중 착용'],
            ['사진', '멈춘 뒤 안전 장소']
        ...
        blocks: [
            ['지금 할 일', '멈춘 뒤 안전한 곳에서 찍으세요.'],
            ['하지 않을 일', '달리는 중 헬멧을 벗기지 마세요.'],
            ['관련', '헬멧 안내를 참고하세요.']
        ],
        links: [
            ['AAP 놀이', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/default.aspx'],
    ...
    {
        id: 'scooter-helmet-must-boundary',
        match: /(킥보드\s*헬멧\s*필수|킥보드\s*헬멧\s*필수|킥보드\s*헬멧\s*안씀|scooter\s*helmet\s*must)/,
        title: '킥보드를 탈 때는 헬멧을 쓰고 차도·급경사를 피하세요',
        lead: '전동 킥보드와 구분하세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['장비', '헬멧'],
            ['환경', '인도·공원, 감독']
        ],
    ...
    {
        id: 'helmet-strap-loose-boundary',
        match: /(헬멧\s*턱끈\s*풀림|헬멧\s*턱끈\s*풀림|헬멧\s*끈\s*느슨|helmet\s*strap\s*loose)/,
        title: '헬멧 턱끈이 헐거우면 보호가 약해지니 두 손가락 여유로 조이세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['핏', '수평, 턱끈'],
            ['교체', '금, 큰 충격 후']
        ...
        blocks: [
            ['지금 할 일', '흔들리지 않게 조절하세요.'],
            ['하지 않을 일', '끈을 풀고 타지 마세요.'],
            ['관련', '헬멧 안내를 참고하세요.']
        ],
        links: [
            ['AAP 놀이', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/default.aspx'],
    ...
    {
        id: 'bike-night-light-boundary',
        match: /(자전거\s*야간\s*라이트|자전거\s*야간\s*라이트|bike\s*night\s*light)/,
        title: '야간 자전거는 라이트·헬멧·밝은 옷을 챙기고 혼잡 도로를 피하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '헬멧·조명'],
            ['주의', '야간 무조명']
    ...
    {
        id: 'helmet-short-ride-boundary',
        match: /(헬멧\s*없이\s*짧은\s*거리|헬멧\s*없이\s*짧은|helmet\s*short\s*ride)/,
        title: '짧은 거리라도 자전거·킥보드 헬멧을 쓰세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '항상 헬멧'],
            ['주의', '잠깐이라 생략']
    ...
    {
        id: 'guest-bag-meds-clear-boundary',
        match: /(손님\s*가방\s*약\s*치우기\s*요청)/,
        title: '손님 가방·코트 속 약도 아이 손이 닿지 않게 치우도록 요청하세요',
        lead: '집 안 약이 아니어도 위험합니다.',
        points: [
            ['지금', '가방 위치 부탁'],
            ['주의', '소파 위 방치']
        ],
    ...
    {
        id: 'fever-med-fridge-door-boundary',
        match: /(해열제\s*냉장고\s*문|해열제\s*냉장고\s*문|약\s*냉장고\s*문\s*칸|fever\s*med\s*fridge\s*door)/,
        title: '냉장고 문 칸 약도 아이 손이 닿지 않게 하고 음료와 구분해 두세요',
        lead: '용량은 표시·처방을 따릅니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['보관', '높은 곳·잠금'],
            ['구분', '음료와 분리']
        ],
    ...
    {
        id: 'used-toy-recall-boundary',
        match: /(리콜\s*중고\s*장난감|중고\s*장난감\s*리콜|장난감\s*중고\s*안전|used\s*toy\s*recall)/,
        title: '중고 장난감은 리콜·작은 부품·페인트 상태를 확인하고 불확실하면 치우세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['확인', '모델, 리콜, 상태'],
            ['금지', '파손·납 페인트 의심']
    ...
    {
        id: 'recall-check-habit-boundary',
        match: /(리콜\s*확인\s*앱|리콜\s*확인\s*습관|제품\s*리콜\s*주기적|recall\s*check\s*habit)/,
        title: '유모차·카시트·장난감은 주기적으로 공식 리콜을 확인하세요',
        lead: '특정 앱·쇼핑몰 순위는 하지 않습니다.',
        points: [
            ['확인', '모델명, 공식 공지'],
            ['조치', '사용 중지']
        ],
    ...
    {
        id: 'carseat-recall-check-habit-boundary',
        match: /(리콜\s*카시트\s*확인|리콜\s*카시트\s*확인|carseat\s*recall\s*check)/,
        title: '카시트 모델명으로 주기적으로 리콜을 확인하세요',
        lead: '등록하면 안내를 받기 쉽습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '모델·리콜 확인'],
            ['주의', '리콜 무시']
        ],
    ...
    {
        id: 'pet-supplement-child-ingest-boundary',
        match: /(강아지\s*영양제\s*아이|강아지\s*영양제\s*아이\s*먹|펫\s*영양제\s*섭취|pet\s*supplement\s*child\s*ingest)/,
        title: '반려동물 영양제·약을 아이 손이 닿지 않게 하고 섭취 시 중독 상담을 하세요',
        lead: '사람 약과 혼동하지 마세요.',
        points: [
            ['보관', '잠금'],
            ['섭취', '상담']
    ...
    {
        id: 'dog-kibble-child-eat-boundary',
        match: /(개\s*사료\s*아이\s*먹음|개\s*사료\s*아이\s*먹|강아지\s*밥\s*주워\s*먹|dog\s*kibble\s*child\s*eat)/,
        title: '개 사료를 아이가 먹지 않게 치우고 많이 먹었다면 중독 상담을 검토하세요',
        lead: '성분·양에 따라 위험이 다릅니다.',
        points: [
            ['예방', '보관, 치우기'],
            ['섭취', '상담']
        ],
        blocks: [
            ['지금 할 일', '사료를 바닥에 흩어 두지 마세요.'],
            ['하지 않을 일', '조금이라고 무시하지 마세요.'],
            ['관련', '펫푸드 섭취 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'dog-treat-pickup-eat-boundary',
        match: /(개\s*간식\s*주워\s*먹음|개\s*간식\s*주워\s*먹|dog\s*treat\s*pickup)/,
        title: '바닥에 떨어진 개 간식을 아이가 주워 먹지 않게 치우세요',
        lead: '많이 먹었다면 중독 상담을 검토하세요.',
        points: [
            ['지금', '치우기·보관'],
            ['주의', '바닥 방치']
        ],
        blocks: [
            ['지금 할 일', '간식을 바닥에 두지 마세요.'],
            ['하지 않을 일', '조금이라고 무시하지 마세요.'],
            ['관련', '펫푸드 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'laundry-pod-clear-jar-boundary',
        match: /(세탁\s*포드\s*투명\s*통|세탁\s*포드\s*투명\s*통|포드\s*사탕\s*처럼|laundry\s*pod\s*clear\s*jar)/,
        title: '세탁 포드를 사탕처럼 보이는 투명 통에 두지 말고 잠가 두세요',
        lead: '오인 섭취가 흔합니다.',
        points: [
            ['보관', '잠금, 원포장'],
            ['금지', '투명 장식 통']
        ...
        blocks: [
            ['지금 할 일', '아이 눈높이에서 치우세요.'],
            ['하지 않을 일', '예쁜 병에 옮겨 담지 마세요.'],
            ['관련', '세탁 포드 안내를 참고하세요.']
        ],
        links: [
            ['AAP 중독', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/Poison-Prevention.aspx'],
    ...
    {
        id: 'cleaner-spray-height-boundary',
        match: /(세제\s*스프레이\s*높이|세제\s*스프레이\s*높이|청소\s*스프레이\s*아이\s*손|cleaner\s*spray\s*height)/,
        title: '세제 스프레이는 아이 손이 닿지 않는 높이에 두고 음료병에 옮기지 마세요',
        lead: '눈·섭취 시 중독 상담을 하세요.',
        points: [
            ['보관', '높은 곳·잠금'],
            ['금지', '음료병 소분']
        ],
    ...
    {
        id: 'laundry-pod-floor-boundary',
        match: /(세탁\s*포드\s*바닥|세탁\s*포드\s*바닥|세제\s*포드\s*떨어|laundry\s*pod\s*floor)/,
        title: '세탁 포드가 바닥에 떨어지면 즉시 주워 잠가 두고 사탕처럼 보이게 두지 마세요',
        lead: '오인 섭취가 흔합니다.',
        points: [
            ['즉시', '수거, 잠금'],
            ['금지', '투명 장식 통']
    ...
    {
        id: 'cleaner-low-shelf-boundary',
        match: /(세제\s*낮은\s*선반|세제\s*낮은\s*선반|cleaner\s*low\s*shelf)/,
        title: '세제를 낮은 선반에 두지 말고 잠그세요',
        lead: '음료병에 옮기지 마세요.',
        points: [
            ['지금', '높은 곳·잠금'],
            ['주의', '낮은 선반·소분']
    ...
    {
        id: 'pod-candy-lookalike-boundary',
        match: /(세제\s*포드\s*사탕\s*오인|세제\s*포드\s*사탕|pod\s*candy\s*lookalike)/,
        title: '세탁 포드를 사탕처럼 보이게 두지 말고 잠가 보관하세요',
        lead: '오인 섭취가 흔합니다.',
        points: [
            ['지금', '잠금·원포장'],
            ['주의', '투명 장식 통']
    ...
    {
        id: 'blackboard-blurry-boundary',
        match: /(칠판이\s*흐릿|칠판\s*흐릿|앞자리\s*안보여|blackboard\s*blurry\s*child)/,
        title: '칠판·화면이 흐리다고 하면 시력 검진을 미루지 마세요',
        lead: '안경 처방은 의료진이 합니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['행동', '시력 검사'],
            ['관찰', '찡그림, 두통']
        ],
        blocks: [
            ['지금 할 일', '학교 검사 결과지를 챙기세요.'],
            ['하지 않을 일', '재검을 미루지 마세요.'],
            ['관련', '시력 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'book-too-close-vision-boundary',
        match: /(근거리\s*책\s*가까이|책\s*가까이\s*봐|코\s*앞에\s*책|book\s*too\s*close\s*vision)/,
        title: '책을 지나치게 가까이 보면 시력 검진을 검토하고 조명·자세를 챙기세요',
        lead: '안경 처방은 의료진이 합니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['환경', '조명, 거리'],
            ['상담', '시력 검사']
    ...
    {
        id: 'cant-see-board-boundary',
        match: /(칠판\s*안\s*보여|칠판\s*안\s*보여|cant\s*see\s*board)/,
        title: '칠판이 안 보인다고 하면 시력 검진을 미루지 마세요',
        lead: '안경 처방은 의료진이 합니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '시력 검사'],
            ['주의', '방치']
    ...
    {
        id: 'amblyopia-patch-boundary',
        match: /(약시\s*안대|약시\s*안대|가림\s*치료\s*안대|amblyopia\s*patch)/,
        title: '약시 가림 치료는 의료진 지시를 지키고 임의로 중단하지 마세요',
        lead: '진단·기간은 안과를 따르세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['준수', '처방 일정'],
            ['금지', '임의 중단']
        ],
    ...
    {
        id: 'amblyopia-treatment-duration-boundary',
        match: /(약시\s*치료\s*기간|약시\s*치료\s*기간|amblyopia\s*treatment\s*duration)/,
        title: '약시 치료 기간·방법은 안과 지시를 따르고 임의로 중단하지 마세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '처방 준수'],
            ['주의', '임의 중단']
    ...
    {
        id: 'color-vision-test-child-boundary',
        match: /(색맹\s*검사\s*아이|색맹\s*검사\s*아이|색각\s*이상\s*검사|color\s*vision\s*test\s*child)/,
        title: '색각 이상이 의심되면 학교·의료 선별 후 전문 검사를 검토하세요',
        lead: '앱 테스트만으로 단정하지 않습니다.',
        points: [
            ['다음', '선별, 진료'],
            ['태도', '비난 금지']
        ],
    ...
    {
        id: 'color-name-confusion-boundary',
        match: /(색\s*이름\s*헷갈림|색\s*이름\s*헷갈림|색깔\s*구\s*분\s*못|color\s*name\s*confusion)/,
        title: '색 이름을 자주 헷갈리면 색각·학습 평가를 검토하고 놀림을 막으세요',
        lead: '앱 테스트만으로 단정하지 않습니다.',
        points: [
            ['다음', '선별, 진료'],
            ['태도', '비난 금지']
    ...
    {
        id: 'crayon-color-mixup-boundary',
        match: /(크레용\s*색\s*혼동|크레용\s*색\s*혼동|crayon\s*color\s*mixup)/,
        title: '크레용 색을 자주 혼동하면 색각 선별을 검토하고 놀림을 막으세요',
        lead: '앱 테스트만으로 단정하지 않습니다.',
        points: [
            ['지금', '선별·진료'],
            ['주의', '놀림']
    ...
    {
        id: 'photo-red-reflex-asymmetry-boundary',
        match: /(사진\s*적목\s*한쪽|사진\s*적목\s*한쪽|눈\s*적색\s*반사\s*다름|photo\s*red\s*reflex\s*asymm)/,
        title: '사진에서 한쪽 눈 반사가 다르게 보이면 앱 진단 대신 안과·소아 진료를 검토하세요',
        lead: '사진만으로 병명을 정하지 않습니다.',
        points: [
            ['상담', '비대칭 반사'],
            ['금지', '사진 단정']
        ],
    ...
    {
        id: 'name-no-response-boundary',
        match: /(이름\s*불러도\s*반응\s*없음|이름\s*불러도\s*반응\s*없음|이름\s*무시\s*청력|name\s*no\s*response\s*hearing)/,
        title: '이름을 불러도 반응이 없으면 상황·청력·주의력을 구분해 평가를 검토하세요',
        lead: '한 번의 무반응으로 단정하지 않습니다.',
        points: [
            ['관찰', '여러 상황 기록'],
            ['상담', '청력·발달']
        ],
        blocks: [
            ['지금 할 일', '언제 반응하는지 적어 보세요.'],
            ['하지 않을 일', '혼만 내지 말고 평가를 검토하세요.'],
            ['관련', '청력 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'tv-volume-hearing-concern-boundary',
        match: /(티비\s*소리\s*키움|티비\s*소리\s*키움|티브이\s*볼륨\s*높아|tv\s*volume\s*hearing\s*concern)/,
        title: '티비 소리를 계속 키운다면 청력·주의력 평가를 검토하세요',
        lead: '한 가지 원인으로 단정하지 않습니다.',
        points: [
            ['관찰', '여러 상황'],
            ['상담', '청력']
        ],
        blocks: [
            ['지금 할 일', '언제 키우는지 기록하세요.'],
            ['하지 않을 일', '혼만 내지 말고 평가를 검토하세요.'],
            ['관련', '청력 안내를 참고하세요.']
        ],
        links: [
    ...
    {
        id: 'call-from-behind-no-response-boundary',
        match: /(뒤에서\s*불러도|뒤에서\s*불러도|call\s*from\s*behind)/,
        title: '뒤에서 불러도 반응이 없으면 상황·청력 평가를 검토하세요',
        lead: '한 번의 무반응으로 단정하지 않습니다.',
        points: [
            ['지금', '여러 상황 기록'],
            ['주의', '혼만 내기']
    ...
    {
        id: 'babywearing-nursing-airway-boundary',
        match: /(아기띠\s*수유\s*자세|아기띠\s*수유\s*자세|슬링\s*수유\s*기도|babywearing\s*nursing\s*airway)/,
        title: '아기띠·슬링 수유 후에도 얼굴이 보이고 코·입이 막히지 않게 다시 조정하세요',
        lead: '졸음 수유 시 질식 위험을 보세요. 브랜드 순위는 하지 않습니다.',
        points: [
            ['기도', '얼굴 보임'],
            ['점검', '수유 후 자세']
        ],
    ...
    {
        id: 'curtain-cord-tie-up-boundary',
        match: /(커튼\s*줄\s*묶기|커튼\s*줄\s*묶|블라인드\s*줄\s*고정|curtain\s*cord\s*tie)/,
        title: '커튼·블라인드 줄은 아이 손이 닿지 않게 묶거나 정리하세요',
        lead: '목 감김 사고가 보고됩니다.',
        points: [
            ['조치', '줄 정리'],
            ['배치', '침대 거리']
    ...
    {
        id: 'blind-cord-loop-boundary',
        match: /(블라인드\s*줄\s*루프|블라인드\s*줄\s*루프|블라인드\s*고리\s*줄|blind\s*cord\s*loop)/,
        title: '블라인드 줄이 고리로 늘어지지 않게 끊거나 정리하세요',
        lead: '목 감김 사고가 보고됩니다.',
        points: [
            ['조치', '고리 제거, 짧게'],
            ['배치', '침대 거리']
    ...
    {
        id: 'blind-cord-near-crib-boundary',
        match: /(블라인드\s*줄\s*침대\s*옆|블라인드\s*줄\s*침대|blind\s*cord\s*crib)/,
        title: '아기 침대 옆 블라인드 줄을 치우거나 짧게 정리하세요',
        lead: '목 감김 사고가 보고됩니다.',
        points: [
            ['지금', '줄 정리·침대 거리'],
            ['주의', '늘어진 줄']
    ...
    {
        id: 'cart-handle-ride-boundary',
        match: /(카트\s*손잡이\s*타기|카트\s*손잡이\s*타|쇼핑카트\s*밀대\s*타|cart\s*handle\s*ride)/,
        title: '쇼핑 카트 손잡이·바구니에 타지 않게 하고 좌석 벨트를 채우세요',
        lead: '전복·낙상이 흔합니다.',
        points: [
            ['좌석', '벨트 칸'],
            ['금지', '손잡이·바구니 탑승']
    ...
    {
        id: 'cart-standing-ride-boundary',
        match: /(카트\s*서서\s*타기|카트\s*서서\s*타|cart\s*standing\s*ride)/,
        title: '쇼핑 카트 안에서 서거나 가장자리에 타지 않게 하세요',
        lead: '낙상·전복이 흔합니다.',
        points: [
            ['지금', '벨트 칸 착석'],
            ['주의', '서서 타기']
    ...
    {
        id: 'water-beads-ban-boundary',
        match: /(워터비즈\s*절대|워터비즈\s*금지|물\s*구슬\s*장난감|water\s*beads\s*ban)/,
        title: '워터비즈는 삼킴·코 삽입 위험이 커 어린 아이 손에 두지 마세요',
        lead: '부풀어 장 폐색 위험이 보고됩니다.',
        points: [
            ['원칙', '치우기'],
            ['응급', '삼킴 의심']
        ],
    ...
    {
        id: 'bath-splash-slip-boundary',
        match: /(목욕\s*장난\s*미끄럼|목욕\s*장난\s*미끄|욕조\s*첨벙\s*넘어|bath\s*splash\s*slip)/,
        title: '목욕 중 첨벙 장난은 미끄럼 부상이 날 수 있어 한 손으로 잡고 감독하세요',
        lead: '자리를 비우지 마세요.',
        points: [
            ['감독', '팔 닿는 거리'],
            ['바닥', '미끄럼 주의']
    ...
    {
        id: 'bus-stroller-secure-boundary',
        match: /(버스\s*유모차\s*고정|버스\s*유모차\s*고정|시내버스\s*유모차|bus\s*stroller\s*secure)/,
        title: '버스에서 유모차는 규정에 맞게 접거나 고정하고 급정거를 대비하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['확인', '지역 규정'],
            ['주의', '문 끼임, 급정거']
    ...
    {
        id: 'subway-door-stroller-boundary',
        match: /(지하철\s*문\s*틈\s*유모차|지하철\s*문\s*유모차|subway\s*door\s*stroller)/,
        title: '지하철 출입문에 유모차 바퀴가 끼지 않게 완전히 들어간 뒤 이동하세요',
        lead: '급정거를 대비하세요.',
        points: [
            ['지금', '문 틈 주의'],
            ['주의', '출입문 정차']
        ...
        blocks: [
            ['지금 할 일', '문이 열린 채 서 있지 마세요.'],
            ['하지 않을 일', '혼잡 시 접기를 검토하세요.'],
            ['관련', '유모차·대중교통 안내를 참고하세요.']
        ],
        links: [
            ['AAP 유모차', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Stroller-Safety.aspx'],
    ...
    {
        id: 'stroller-brake-check-boundary',
        match: /(유모차\s*브레이크|유모차\s*브레이크\s*점검|유모차\s*밀림|stroller\s*brake\s*check)/,
        title: '유모차 정차 시 브레이크를 걸고 벨트를 채우세요',
        lead: '경사진 곳에서 밀릴 수 있습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['습관', '브레이크, 벨트'],
            ['금지', '손잡이 과적']
        ],
        blocks: [
            ['지금 할 일', '멈출 때마다 브레이크를 확인하세요.'],
            ['하지 않을 일', '아기를 벨트로 안 묶고 두지 마세요.'],
            ['관련', '유모차 안내를 참고하세요.']
        ],
        links: [
            ['AAP 유모차', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Stroller-Safety.aspx'],
    ...
    {
        id: 'stroller-fold-finger-boundary',
        match: /(유모차\s*접힘\s*손가락|유모차\s*접힘\s*손가락|유모차\s*접을\s*때\s*손|stroller\s*fold\s*finger)/,
        title: '유모차를 접을 때 아이 손·손가락이 끼지 않게 하고 잠금을 확인하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['접기', '아이 분리 후'],
            ['점검', '접힘 잠금']
        ...
        blocks: [
            ['지금 할 일', '아이를 내린 뒤 접으세요.'],
            ['하지 않을 일', '손가락이 경첩에 닿지 않게 하세요.'],
            ['관련', '유모차 안내를 참고하세요.']
        ],
        links: [
            ['AAP 유모차', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Stroller-Safety.aspx'],
    ...
    {
        id: 'stroller-buckle-every-time-boundary',
        match: /(유모차\s*벨트\s*매기|유모차\s*벨트\s*매번|stroller\s*buckle\s*every)/,
        title: '유모차에 앉힐 때마다 벨트를 채우고 브레이크를 확인하세요',
        lead: '브랜드 순위는 하지 않습니다.',
        points: [
            ['지금', '벨트·브레이크'],
            ['주의', '벨트 없이 방치']
    ...
    {
        id: 'apartment-fire-escape-boundary',
        match: /(아파트\s*화재\s*대피|아파트\s*화재\s*대피|공동주택\s*불\s*대피|apartment\s*fire\s*escape)/,
        title: '아파트 화재 시 엘리베이터를 쓰지 말고 대피 경로와 만날 장소를 연습하세요',
        lead: '연기 속에서는 낮게 이동 안내를 따르세요.',
        points: [
            ['연습', '계단, 만날 장소'],
            ['금지', '엘리베이터']
        ],
    ...
    {
        id: 'smoke-crawl-low-boundary',
        match: /(연기\s*속\s*낮게\s*이동|연기\s*속\s*낮게|화재\s*연기\s*기어|smoke\s*crawl\s*low)/,
        title: '화재 연기가 있으면 낮게 이동하고 엘리베이터를 쓰지 마세요',
        lead: '만날 장소를 미리 정하세요.',
        points: [
            ['대피', '낮게, 계단'],
            ['금지', '엘리베이터, 물건 챙기기']
    ...
    {
        id: 'fire-meet-place-boundary',
        match: /(화재\s*대피\s*만날\s*장소|화재\s*만날\s*장소|fire\s*meet\s*place)/,
        title: '화재 대피 시 가족 만날 장소를 정해 연습하세요',
        lead: '엘리베이터를 쓰지 마세요.',
        points: [
            ['지금', '만날 장소·계단'],
            ['주의', '물건 챙기기']
    ...
    {
        id: 'tent-heater-co-boundary',
        match: /(캠핑\s*텐트\s*난로|텐트\s*난로\s*일산|캠핑\s*텐트\s*히터|tent\s*heater\s*co)/,
        title: '텐트 안에서 연료 난로·숯을 쓰지 마세요. 일산화탄소 위험이 큽니다',
        lead: '경보기와 환기를 검토하세요.',
        points: [
            ['금지', '밀폐 연소'],
            ['증상', '두통, 구토, 처짐']
        ...
        blocks: [
            ['지금 할 일', '야외 전용 장비를 확인하세요.'],
            ['하지 않을 일', '텐트 안 숯불을 피우지 마세요.'],
            ['관련', '일산화탄소 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'co-alarm-going-off-boundary',
        match: /(일산화탄소\s*경보\s*울림|일산화탄소\s*경보\s*울림|CO\s*경보\s*울려|co\s*alarm\s*going\s*off)/,
        title: '일산화탄소 경보가 울리면 밖으로 대피하고 119·가스 안전에 연락하세요',
        lead: '두통·구토·처짐이 있으면 진료하세요.',
        points: [
            ['즉시', '대피, 환기'],
            ['금지', '다시 들어가 확인만']
        ],
        blocks: [
            ['지금 할 일', '모두를 밖으로 내보내세요.'],
            ['하지 않을 일', '경보를 끄고 무시하지 마세요.'],
            ['관련', '일산화탄소 안내를 참고하세요.']
        ],
        links: [
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx'],
    ...
    {
        id: 'gas-stove-vent-co-boundary',
        match: /(가스레인지\s*환기|가스레인지\s*환기|gas\s*stove\s*vent)/,
        title: '가스레인지 사용 시 환기를 하고 CO 경보기를 설치·시험하세요',
        lead: '두통·구토·처짐이면 대피·진료하세요.',
        points: [
            ['지금', '환기·경보'],
            ['주의', '밀폐 연소']
    ...
    {
        id: 'walker-like-assist-boundary',
        match: /(걸음마\s*보조기|걸음마\s*보조기|워커\s*유사\s*기구|walking\s*assist\s*device\s*infant)/,
        title: '걸음마 보조 기구는 넘어짐·위험 접근을 키울 수 있어 사용을 재고하세요',
        lead: '보행기는 권장되지 않는 안내가 많습니다. 브랜드 순위는 하지 않습니다.',
        points: [
            ['원칙', '바닥 놀이, 감독'],
            ['경계', '바퀴 보조기']
        ],
        blocks: [
            ['지금 할 일', '안전한 공간에서 손을 잡고 연습하세요.'],
            ['하지 않을 일', '위험 구역 접근 기구를 쓰지 마세요.'],
            ['관련', '보행기·첫 신발 안내를 참고하세요.']
        ],
        links: [
            ['AAP 놀이', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/default.aspx'],
            ['AAP 가정 안전', 'https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx']
    ...
    {
        id: 'barefoot-indoor-walking-boundary',
        match: /(맨발\s*실내\s*걸음마|맨발\s*실내\s*걸음마|집\s*안\s*맨발\s*걷기|barefoot\s*indoor\s*walking)/,
        title: '실내 걸음마는 맨발·미끄럼 방지 환경을 검토하고 미끄러운 양말을 조심하세요',
        lead: '브랜드 순위는 하지 않습니다. 통증·절뚝이면 진료하세요.',
        points: [
            ['환경', '미끄럼 없는 바닥'],
            ['주의', '큰 양말']
    ...
    {
        id: 'first-shoes-when-boundary',
        match: /(걸음마\s*신발\s*언제|걸음마\s*신발\s*언제|first\s*shoes\s*when)/,
        title: '실내 걸음마는 맨발·미끄럼 방지를 검토하고 실외·보호가 필요할 때 신발을 검토하세요',
        lead: '브랜드 순위는 하지 않습니다. 통증·절뚝이면 진료하세요.',
        points: [
            ['지금', '환경에 맞게'],
            ['주의', '너무 이른 딱딱한 신발 강요']
        ...
        blocks: [
            ['지금 할 일', '미끄러운 바닥을 조심하세요.'],
            ['하지 않을 일', '큰 신발을 신기지 마세요.'],
            ['관련', '첫 신발 안내를 참고하세요.']
        ],
        links: [
            ['AAP 놀이', 'https://www.healthychildren.org/English/safety-prevention/at-play/Pages/default.aspx'],
    ...
    {
        id: 'lice-comb-method-boundary',
        match: /(이\s*빗질\s*방법|이\s*빗질\s*방법|머릿니\s*참빗|lice\s*comb\s*method)/,
        title: '머릿니 빗질은 설명에 따라 젖은 머리카락에서 하고, 치료 일정은 안내를 따르세요',
        lead: '제품 순위는 하지 않습니다. 용량은 표시·의료진을 따르세요.',
        points: [
            ['방법', '참빗, 구간별'],
            ['태도', '수치심 금지']
        ],
    ...
    {
        id: 'airplane-bassinet-boundary',
        match: /(항공기\s*요람|항공기\s*요람|비행기\s*베시넷|airplane\s*bassinet)/,
        title: '항공기 요람은 항공사 규정·체중 한도를 확인하고 난기류 시 지시를 따르세요',
        lead: '무릎 탑승보다 별도 좌석·카시트가 더 안전할 수 있습니다.',
        points: [
            ['확인', '예약, 한도'],
            ['주의', '난기류']
        ],
        blocks: [
            ['지금 할 일', '항공사 정책을 미리 보세요.'],
            ['하지 않을 일', '요람에 방치하지 마세요.'],
            ['관련', '비행·카시트 안내를 참고하세요.']
        ],
        links: [
            ['AAP 외출', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/default.aspx'],
    ...
    {
        id: 'landing-cry-ear-pressure-boundary',
        match: /(착륙\s*시\s*울음\s*귀|착륙\s*울음\s*귀|이착륙\s*아기\s*울|landing\s*cry\s*ear)/,
        title: '이착륙 때 울음은 귀 압력일 수 있어 수유·삼킴을 돕고 지속 통증은 진료를 검토하세요',
        lead: '중이염이 있으면 의료진과 비행을 상의하세요.',
        points: [
            ['도움', '수유, 삼킴'],
            ['상담', '지속 통증, 발열']
        ],
        blocks: [
            ['지금 할 일', '이착륙 때 수유해 보세요.'],
            ['하지 않을 일', '귀를 세게 막지 마세요.'],
            ['관련', '비행기 귀 안내를 참고하세요.']
        ],
        links: [
            ['AAP 외출', 'https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/default.aspx'],
    ...
    {
        id: 'takeoff-feed-timing-boundary',
        match: /(이륙\s*수유\s*타이밍|이륙\s*수유\s*타이밍|takeoff\s*feed\s*timing)/,
        title: '이륙·착륙 때 수유·삼킴을 맞추면 귀 불편을 줄일 수 있습니다',
        lead: '중이염이 있으면 의료진과 비행을 상의하세요.',
        points: [
            ['지금', '이착륙 수유'],
            ['주의', '귀 통증 방치']
